						...
						<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
							<div class="main1">
								<div class="content">						
									...
									if ($accion =="imprimir")
											{
											$elsql="select s.nsocio, right(f.dni,3) as cod,s.foto, CONCAT(f.apellido, ', ', f.nombre) as nombre, f.dni, c.descripcion, 
											p.descripcion as plan, ps.vencimiento, f.foto from plan_socio_familiar psf inner join familiares f on f.id = psf.familiar_id 
											inner join plan_socio ps on ps.id = psf.plan_socio_id inner join planes p on p.id = ps.plan_id inner join socios s on s.id = ps.socio_id 
											inner join categorias c on c.id = s.categoria_id where psf.id = '$idf'";
											...
											?>
												<div class="css-shapes-preview">
													...
													&nbsp;<img class="img-rounded" src="foto\familiar\<?php echo $datos['foto'];?>" width="50px" height="50px">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Club FFAA - Córdoba &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													&nbsp;<img class="img-rounded" src="img\logo.jpg" width="50px" height="50px"><hr>
													<h5 class="text-right"> &nbsp; <b><?php echo $datos['plan'];?></b> &nbsp;</h5>
													<h5 class="text-left"> &nbsp; <?php echo $datos['nsocio'].'-'.$datos['cod'];?> &nbsp;-&nbsp; <?php echo $datos['nombre'];?> &nbsp;</h5>
