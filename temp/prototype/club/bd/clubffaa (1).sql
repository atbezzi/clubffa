...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2017 a las 00:26:49
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_PLANES_CREATE` (IN `pdescripcion` VARCHAR(255), IN `pcategoria_id` INT(10), IN `pcantidad_familiar` INT(11), IN `pcantidad_cuota` INT(11), IN `pimporte` DECIMAL(11,2), IN `psocial` ENUM('Si','No'))  NO SQL
INSERT INTO planes (descripcion, categoria_id, cantidad_familiar, cantidad_cuota, importe, social)
VALUES (pdescripcion, pcategoria_id, pcantidad_familiar, pcantidad_cuota, pimporte, psocial)$$
...
CREATE TABLE `cuotas` (
  ...
  `familiar_id` int(10) UNSIGNED DEFAULT NULL,
  `embarcacion_id` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `planes` (
  ...
  `importe` decimal(11,2) NOT NULL,
  `social` enum('Si','No') COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'Si',
