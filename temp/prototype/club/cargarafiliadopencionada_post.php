...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				if($add){
					if($add2){
						if($add3){
							header("location:cargarafiliadopencionada.php?retorno=Cargado correctamente&m=s");
						}else{
							header("location:cargarafiliadopencionada.php?retorno=" ."El numero de socio ya existe");
						}
					}else{
						header("location:cargarafiliadopencionada.php?retorno=" ."El numero de socio ya existe");
					}
