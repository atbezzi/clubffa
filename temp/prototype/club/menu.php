	...
	<i class="toggle-btn" data-toggle="collapse" data-target="#menu-content"><span class="glyphicon glyphicon-align-justify"></span></i>
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				...
				<li <?=echoActiveClassIfRequestMatches("movimientospagos")?>><a href="movimientospagos.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-stats"></span>&nbsp;Movimientos</a></li>
				</ul>
