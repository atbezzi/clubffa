...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Consultar Cobro</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="consultarcobro_post.php">
								...
								<div class="content">
									<div class="table-responsive">
										<table class="table table-striped table-bordered">
											...
											<th class="warning">Socio</th>
											<th class="warning">Recibo</th>
