<?php 
	...
	if($_SESSION['tipo'] != 'AU' AND $_SESSION['tipo'] !='F'){
...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Accesos al Sistema</h2>
						<br><br>
						<div class="table-responsive">
							<table class="table table-striped table-bordered">
								...
								<th  class="warning">Fecha de Acceso</th>
								</tr>
								<?php 
									$usrtarget = $_SESSION['usuario'];
									$elsql="SELECT * from log_accesos order by codigo desc ";
