...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Carga de Afiliados Pencionada</h2>
					<a href="consultarformularios.php"><span class="glyphicon glyphicon-share-alt" aria-hidden="true">Volver</span></a>
					<hr>
					<form id="frmcarga" name="frmcarga" method="post" action="cargarafiliadopencionada_post.php">
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Provincia Pencionada:</label>
							<?php
							$res=mysql_query("select * from provincias");
							?>
						...
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Localidad Pencionada:</label>
					...
					<label color="White" type="text">&nbsp;</label><hr>
					<a href="consultarformularios.php"><span class="glyphicon glyphicon-share-alt" aria-hidden="true">Volver</span></a>
				</div>
			</div>
			<br><br>
