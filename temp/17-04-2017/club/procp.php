...
?>
<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Localidad Servicio:</label>
<select type="text" name="localidadserv" class="form-control" id="localidadserv" value="">
