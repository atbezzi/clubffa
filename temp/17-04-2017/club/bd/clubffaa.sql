...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-04-2017 a las 01:42:17
...
(1, 'Cat 1', 'C', 'Si', '100.00', '100.00', '120.00', 2, 7, 'Militar', 'Activo', '2017-02-19', 'administrador', '2017-04-01', 'administrador'),
(2, 'Cat 3', 'Ce', 'Si', '10.00', '10.00', '10.00', 2, 2, 'Pensionista', 'Activo', '2017-02-19', 'administrador', '2017-02-19', 'administrador'),
(3, 'Cat 2', 'C', 'Si', '100.00', '100.00', '120.00', 2, 3, 'Civil', 'Activo', '2017-03-04', 'administrador', '0000-00-00', '');
...
(1, 1, 'www', 'www', NULL, NULL, 111, 'Soltero', 'Masculino', 'www', NULL, NULL, 111, 'Activo', '2017-02-19', 'administrador', '0000-00-00', ''),
(2, 2, 'bbb', 'bbb', NULL, NULL, 222, 'Soltero', 'Masculino', 'bbb', NULL, NULL, 222, 'Inactivo', '2017-02-19', 'administrador', '2017-02-19', '');
...
(1, '123', 'Adrian', 'Bezzi', 1539, '14/02/1989', 34091150, 'Soltero', 'Masculino', 'Pasaje Espania 1439', 'Nueva Cba', 1428, 5186, '0351153469105', '3513469105', 'atbezzi@gmail.com', 'SMSV', 'No se sabe', 'Guemes', 1280, 1, 'Primero', 'Unica', 'Civil', 3, 'No', 'Activo', '2017-04-09', 'secretario', '2017-04-10', 'secretario'),
(2, '789', 'Juana', 'Detal', 1, '28/12/1998', 23312332, 'Viudo', 'Femenino', 'Unlugar', 'Otrolugar', 330, 2321, '342233555', '222345788', 'fulanita@gmail.com', 'Cobrador', 'No se sabe', 'No se sabe', 1245, 2, 'Tercero', 'Tercera', 'Pensionista', 2, 'No', 'Activo', '2017-04-09', 'secretario', '2017-04-17', 'secretario'),
(3, '456', 'Roberto', 'Altamira', 1613, '25/12/1988', 3422155, 'Soltero', 'Masculino', 'Entre Rio75', 'Centro', 543, 5000, '351234532', '3514222666', 'zfaltamira@gamail.com', 'Cobrador', 'No se sabe', 'No se sabe', 1751, 2, 'Segundo', 'Dos', 'Militar', 1, 'No', 'Activo', '2017-04-09', 'secretario', '2017-04-10', 'secretario'),
(4, '987', 'Eltipo', 'Facha', 2272, '01/01/1989', 33000999, 'Viudo', 'Masculino', 'La concha de la lora', 'Patronato', 1684, 2167, '33420789', '330214987', 'eltipo@facha.com', 'SMSV', 'No se sabe', 'No se sabe', 1437, 2, 'Rayuela', 'Notarial', 'Civil', 3, 'Si', 'Activo', '2017-04-10', 'secretario', '0000-00-00', '');
...
(1, 1, 'Analista', 'Auto', 'Guemes', 17, 'Activo', '2017-04-09', 'secretario', '2017-04-10', 'secretario'),
(2, 4, 'Pintoresco', 'No se sabe', 'No se sabe', 1538, 'Activo', '2017-04-10', 'secretario', '0000-00-00', '');
...
CREATE TABLE `sociosm` (
  ...
  `localidad_id` int(10) UNSIGNED DEFAULT NULL,
  `serviciodesde` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `serviciohasta` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `estado` enum('Activo','Inactivo') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Activo',
  `fechaalta` date DEFAULT NULL,
  `idaltausuario` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fechaupdate` date DEFAULT NULL,
...
(1, 3, 'Activo', 'Alto', 'Marine', 'Uno', 'Carlos', 1342, '05/01/2009', '09/04/2017', 'Activo', '2017-04-09', 'secretario', '2017-04-10', 'secretario');
...
(1, 2, 'Medio', 'Tierra', 'Dos', 'Pedrito', 1461, '28/12/2008', '09/04/2017', 'Activo', '2017-04-09', 'secretario', '2017-04-17', 'secretario');
...
INSERT INTO `solicitudes` (`id`, `socio_id`, `tipo`, `estado`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
(1, 1, 'Ingreso', 'Pendiente', '2017-04-09', 'secretario', '0000-00-00', ''),
(2, 2, 'Ingreso', 'Pendiente', '2017-04-09', 'secretario', '0000-00-00', ''),
(3, 3, 'Ingreso', 'Pendiente', '2017-04-09', 'secretario', '0000-00-00', ''),
(4, 4, 'Ingreso', 'Pendiente', '2017-04-10', 'secretario', '0000-00-00', '');
...
(4, 'tesorero', 'e10adc3949ba59abbe56e057f20f883e', 'tes@tes.com', 'Activo', 'Tesorero', '2017-02-19', 'administrador', '0000-00-00', '', NULL),
...
(1, 'Zona 2', NULL, 'Nortes', 381, 'Activo', '2017-02-19', 'administrador', '2017-02-19', 'administrador'),
(2, 'Zona 4', NULL, 'Sur', 1552, 'Activo', '2017-02-19', 'administrador', '2017-04-01', 'administrador');
