      ...
      function buscar($b) {
			...
			<?php
				...
				<tr>
					...
					<?php if ($tipo=="Civil")
					{?>
					<a href="modificarformularioscivil.php?accion=modifica&idu=<?php echo $row['idsoc'];?>&close=dor">
					<?php	}
							if ($tipo=="Pensionista")
							{
						?>
						<a href="modificarformulariospensionista.php?accion=modifica&idu=<?php echo $row['idsoc'];?>&close=dor">
						<?php
							}
						?>
					<?php if ($tipo=="Militar")
					{?>
					<a href="modificarformulariosmilitar.php?accion=modifica&idu=<?php echo $row['idsoc'];?>&close=dor">
					<?php	}?>
