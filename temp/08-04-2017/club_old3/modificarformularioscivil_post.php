...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				$add2 = mysql_query("INSERT INTO sociosc (id,socio_id,ocupacion,domicilio,barrio,localidad_id,estado,fechaalta,idaltausuario,fechaupdate,idmodificausuario) VALUES('$elmaximo2','$vnumsocio','$vocupacion','$vdomiciocupa','$vbarrioocupa','$vlocalidadocupa','Activo',NOW(),'$vidaltausuario','','')");
