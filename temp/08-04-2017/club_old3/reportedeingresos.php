			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="reportedeingresos_post.php">
						...
						<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Seleccione el año:</label>
						<div class="input-group">
						  <input type="text" name="fechanac" class="form-control" id="fechanac" onkeydown="return validarNumeros(event)" placeholder="Introduce una fecha" value="<?php echo $vcodigoafilia;?>">
							...
							<div class="main1">
								<div class="content">
									<div class="table-responsive">
										...
										<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-usd"></span>&nbsp;Ingreso Total: <?php echo $_SESSION['total']; ?></label>
									</div>
								</div>
							</div>
						</div>
