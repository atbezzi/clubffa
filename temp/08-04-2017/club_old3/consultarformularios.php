							...
							<table class="table table-striped table-bordered">
								...
								// echo $elsql;
									...
									<tr>
										...
										{?>
										<a href="modificarformularioscivil.php?accion=modifica&idu=<?php echo $datos['idsocio'];?>&close=dor">
										<?php	}
												if ($datos['tipo']=="Pensionista")
												{
											?>
											<a href="modificarformulariospensionista.php?accion=modifica&idu=<?php echo $datos['idsocio'];?>&close=dor">
											<?php
												}
											?>
										<?php if ($datos['tipo']=="Militar")
										{?>
										<a href="modificarformulariosmilitar.php?accion=modifica&idu=<?php echo $datos['idsocio'];?>&close=dor">
										<?php	}?>
