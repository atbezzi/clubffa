	...
	<i class="toggle-btn" data-toggle="collapse" data-target="#menu-content"><span class="glyphicon glyphicon-align-justify"></span></i>
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				...
				<li <?=echoActiveClassIfRequestMatches("consultarcuotasocio")?>><a href="consultarcuotasocio.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-user"></span>&nbsp;Socio</a></li>
				<li <?=echoActiveClassIfRequestMatches("reportedeingresos")?>><a href="reportedeingresos.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-search"></span>&nbsp;Reporte de Ingresos</a></li>
				</ul>
				<li> <?=echoActiveClassIfRequestMatches("tarifas")?><a href="tarifas.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-search"></span>&nbsp;Tarifas</a></li>
				<?php } ?>
				...
				<li <?=echoActiveClassIfRequestMatches("altasolicitudpres")?>><a href="altasolicitudpres.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-floppy-save"></span>&nbsp;Alta</a></li>
				<li <?=echoActiveClassIfRequestMatches("bajasolicitudpres")?>><a href="bajasolicitudpres.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-floppy-save"></span>&nbsp;Baja</a></li>
				<li <?=echoActiveClassIfRequestMatches("consulsolicitudpres")?>><a href="consulsolicitudpres.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-search"></span>&nbsp;Consultar  <span class="badge"><?php echo $cantpend;?></a></li>
				</ul>
				<?php } ?>
				<li>
