			...
			<?php
				...
				<tr>
					...
					<td>
									...
									if ($row['tipo'] == 'Civil'){
										echo '<h4><a href="modificarformularioscivil.php?accion=modifica&idu='.$row['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
									}else{
										if ($row['tipo'] == 'Pensionista'){
											echo '<h4><a href="modificarformulariospensionista.php?accion=modifica&idu='.$row['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
										}else{
											if ($row['tipo'] == 'Militar'){
												echo '<h4><a href="modificarformulariosmilitar.php?accion=modifica&idu='.$row['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
											}
										}
									}
									?>
