							...
							<table class="table table-striped table-bordered">
								...
								// echo $elsql;
									...
									<tr>
										...
										<td>
										<?php if ($datos['tipo']=="Civil")
										{?>
										<a href="consultarformularioscivil.php?accion=consultar&idu=<?php echo $datos['idsocio'];?>&close=dor">
										<?php	}
												if ($datos['tipo']=="Pensionista")
												{
											?>
											<a href="consultarformulariospensionista.php?accion=consultar&idu=<?php echo $datos['idsocio'];?>&close=dor">
											<?php
												}
											?>
										<?php if ($datos['tipo']=="Militar")
										{?>
										<a href="consultarformulariosmilitar.php?accion=consultar&idu=<?php echo $datos['idsocio'];?>&close=dor">
										<?php	}?>
