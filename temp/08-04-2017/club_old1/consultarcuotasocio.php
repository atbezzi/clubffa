...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-search"></span>&nbsp;Consultar Cuota Socio</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="consultarcuotasocio_post.php">
						...
						<input type="text" name="dni" class="form-control" id="dni" placeholder="DNI del Socio" value="<?php echo $vfechanac;?>" disabled>
						</div>
						<div class="col-lg-4 col-md-6 col-sx-12 form-group text-center">
						...
						<div style="padding-left:15px;padding-right:15px">
							...
							<input style="margin-top: 10px; text-align:center" id="cargar" name="cargar" type="button" class="pull-right botoncss" value="Enviar Solicitud" >
						</div>
				</div>
	...
	<script type="text/javascript">
			jQuery('#frmcarga').on('click', '#cargar', function(event) {
				if(document.getElementById("codigoafi").value.trim() != ""){
					...
					alert("Debe ingresar un codigo de socio");
				}
			});
	</script>
	<script type="text/javascript">
