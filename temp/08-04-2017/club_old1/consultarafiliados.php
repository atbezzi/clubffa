						  ...
						  <table class="table table-striped table-bordered">
							...
							// echo $elsql;
								...
								<tr>
									...
									if ($datos['tipo'] == 'Civil'){
										echo '<h4><a href="modificarformularioscivil.php?accion=modifica&idu='.$datos['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
									}else{
										if ($datos['tipo'] == 'Pensionista'){
											echo '<h4><a href="modificarformulariospensionista.php?accion=modifica&idu='.$id['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
										}else{
											if ($datos['tipo'] == 'Militar'){
												echo '<h4><a href="modificarformulariosmilitar.php?accion=modifica&idu='.$id['id'].'&close=dor"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></h4>';
											}
										}
									}
									?>
