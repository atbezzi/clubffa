...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				$querycaja2=" select ifnull(max(id),0)+1 as maxid2 from sociosp";
				...
				$add = mysql_query("INSERT INTO socios (id,nsocio,nombre,apellido,localidadnacimiento,fechanacimiento,dni,estadocivil,sexo,domicilio,barrio,localidad_id,cp,telefono,celular,email,formadepago,domiciliocobrador,barriocobrador,localidad_idcobrador,zona_id,libro,acta,tipo,categoria_id,estadoembarcadero,estado,fechaalta,idaltausuario,fechaupdate,idmodificausuario) VALUES('$elmaximo','$vnumsocio','$vnombre','$vapellido','$vlocalidad','$vfechanac','$vdni','$vestadocivil','$vsexo','$vcalle','$vbarrio','$vlocalidadviveen','$vcpostal','$vtelefono','$vcelular','$vemail','$vformapago','$vdomicobrador','$vbarriocobrador','$vlocalidadcobra','$vzona','$vlibro','$vacta','Pensionista','$vcategorias','$vembarca','Pendiente',NOW(),'$vidaltausuario','','')");
				$add2 = mysql_query("INSERT INTO sociosp (id,socio_id,grado_id,fuerza_id,escalafon_id,promovidopor,localidad_id,serviciodesde,serviciohasta,estado,fechaalta,idaltausuario,fechaupdate,idmodificausuario) VALUES('$elmaximo2','$vnumsocio','$vgrado','$vfuerza','$vescalafon','$vpromovidopor','$vlocalidadpen','$vfechaini','$vfechahasta','Activo',NOW(),'$vidaltausuario','','')");
				$add3 = mysql_query("INSERT INTO solicitudes (id,socio_id,tipo,estado,fechaalta,idaltausuario,fechaupdate,idmodificausuario) VALUES('$elmaximo3','$vnumsocio','Ingreso','Pendiente',NOW(),'$vidaltausuario','','')");
				...
				if($add){
					if($add2){
						if($add3){
							...
							header("location:cargarafiliadocivil.php?retorno=" .mysql_error());
						}
					}else{
						header("location:cargarafiliadocivil.php?retorno=" .mysql_error());
					}
