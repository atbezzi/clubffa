...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				$add2 = mysql_query("UPDATE sociosc SET ocupacion = '$vocupacion', domicilio = '$vdomiciocupa', barrio = '$vbarrioocupa', localidad_id = '$vlocalidadocupa', fechaupdate = NOW(), idmodificausuario = '$usuariocarga' WHERE socio_id = '$idu'");
