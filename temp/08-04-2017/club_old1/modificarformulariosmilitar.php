	...
	if ($accion =="modifica")
			{
				...
				while($datos = mysql_fetch_array($resp)) {
					...
					$vlocalidadmil = $datos['localidad_id'];
...
<div id="container">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					...
					<hr>
					<form id="frmcarga" name="frmcarga" method="post" action="cargarafiliadomilitar_post.php">
	...
	loadmodifica4(<?php echo $vprovmil.",".$vlocalidadmil; ?>);
	</script>
	<script type="text/javascript">
