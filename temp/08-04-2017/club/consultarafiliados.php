...
<div id="container">
						  ...
						  <table class="table table-striped table-bordered">
							...
							// echo $elsql;
								...
								<tr>
									...
									<td>
									<a href="#?accion=consultar&idu=<?php echo $datos['id'];?>&close=dor" data-toggle="modal" data-target="#myModal" data-id="<?php echo $datos['id'];?>">
	 ...
	 $("a[data-toggle=modal]").click(function() 
    {
	 ...
	 success: function( data ){
								...
								document.getElementById("lblzona_id").innerHTML = data.zona_id;
								document.getElementById("lbllibro").innerHTML = data.libro;
								document.getElementById("lblacta").innerHTML = data.acta;
								document.getElementById("lblcategoria_id").innerHTML = data.categoria_id;
