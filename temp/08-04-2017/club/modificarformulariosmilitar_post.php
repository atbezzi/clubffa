...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				$add = mysql_query("UPDATE socios SET nsocio = '$vnumsocio', nombre = '$vnombre', apellido = '$vapellido', localidadnacimiento = '$vlocalidad', 
				...
				$add2 = mysql_query("UPDATE sociosm SET situacionmilitar = '$vsitumilitar', grado_id = '$vgrado', fuerza_id = '$vfuerza', 
				escalafon_id = '$vescalafon', promovidopor = '$vpromovidopor', localidad_id = '$vlocalidadmil', serviciodesde = '$vfechaini', 
