...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-02-2017 a las 22:39:39
...
CREATE TABLE `categorias` (
  ...
  `derechovoto` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
  `cantidadextension` int(11) NOT NULL,
  `cantidadavalante` int(11) NOT NULL,
  `tipo` enum('Civil','Pensionista','Militar') COLLATE utf8_unicode_ci NOT NULL,
  `activo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `idaltacategoria` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `idupdatecategoria` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `categorias` (`id`, `descripcion`, `descripcionbreve`, `importeinscripcion`, `importefamiliar`, `importecuota`, `derechovoto`, `cantidadextension`, `cantidadavalante`, `tipo`, `activo`, `created_at`, `idaltacategoria`, `updated_at`, `idupdatecategoria`) VALUES
(1, 'Cat 111222', 'C', '100.00', '120.00', '110.00', 'Si', 1, 5, 'Militar', 'N', '2017-02-12 21:43:22', 'administrador', '2017-02-12 22:27:31', 'administrador'),
(2, 'Cat 111333', 'C', '100.00', '120.00', '110.00', 'Si', 1, 5, 'Militar', 'S', '2017-02-12 22:17:53', 'administrador', '2017-02-12 22:27:44', 'administrador'),
(3, 'Cat 111444', 'C', '100.00', '120.00', '110.00', 'Si', 1, 5, 'Militar', 'N', '2017-02-12 22:19:30', 'administrador', '2017-02-12 22:27:51', 'administrador');
...
CREATE TABLE `cobradores` (
  ...
  `activo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `idusuariocarga` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `idupdateusuario` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `cobradores` (`id`, `nombre`, `apellido`, `dni`, `domicilio`, `telefono`, `zona_id`, `activo`, `created_at`, `idusuariocarga`, `updated_at`, `idupdateusuario`) VALUES
(1, 'pepe', 'pepito', 321, 'porahi', 123, 7, '', '2017-02-11 03:00:00', 'administrador', NULL, NULL),
(2, 'fffffff', 'aaaa', 2222, 'zzzzz', 1111, 8, 'N', '2017-02-11 13:48:59', 'administrador', '2017-02-11 16:42:59', 'administrador'),
(3, 'x', 'bezzi', 123, 'toto', 123, 8, 'S', '2017-02-11 14:03:48', 'administrador', '2017-02-11 16:42:38', 'administrador');
...
CREATE TABLE `contactos` (
  ...
  `tipo` enum('Privado','Profesional','Otro') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Privado',
  `cobra` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
  `zona_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `estados` (
  ...
  `cantidadcuotaadeuda` int(11) NOT NULL,
  `interescuota` decimal(11,2) NOT NULL,
  `estadoanterior` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `estadoposterior` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tipo` enum('Activo','Inactivo') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Activo',
  `imprimecupon` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Si',
  `reingreso` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Si',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `localidades` (`id`, `id_provincia`, `localidad`, `created_at`, `updated_at`) VALUES
...
(1, 'faltamira', '2016-10-18 09:30:22'),
(2, 'atbezzi', '2016-10-18 09:31:58'),
(3, 'faltamira', '2016-10-18 10:54:11'),
(4, 'faltamira', '2016-10-18 10:58:27'),
(5, 'faltamira', '2016-10-18 11:20:52'),
(6, 'fulanito', '2016-10-18 11:26:18'),
(7, 'altausuario', '2016-10-18 11:27:15'),
(8, 'fulanito', '2016-10-18 11:27:38'),
(9, 'auditor', '2016-10-18 11:37:19'),
(10, 'faltamira', '2016-10-18 11:37:53'),
(11, 'faltamira', '2016-10-18 11:38:40'),
(12, 'atbezzi', '2016-10-19 17:33:54'),
(13, 'faltamira', '2016-10-19 17:34:14'),
(14, 'atbezzi', '2016-10-19 17:35:11'),
(15, 'faltamira', '2016-10-19 17:38:15'),
(16, 'atbezzi', '2016-10-19 17:38:32'),
(17, 'atbezzi', '2016-10-21 17:20:16'),
(18, 'atbezzi', '2016-10-21 18:31:53'),
(19, 'faltamira', '2016-10-21 18:32:44'),
(20, 'atbezzi', '2016-10-21 18:34:11'),
(21, 'faltamira', '2016-10-21 18:34:22'),
(22, 'atbezzi', '2016-10-25 10:25:11'),
(23, 'atbezzi', '2016-10-27 11:52:16'),
(24, 'tesorero', '2016-10-27 11:53:20'),
(25, 'tesorero', '2016-10-27 11:53:54'),
(26, 'tesorero', '2016-10-27 14:00:40'),
(27, 'atbezzi', '2016-10-28 11:56:54'),
(28, 'tesorero', '2016-10-28 11:57:13'),
(29, 'tesorero', '2016-10-28 12:33:08'),
(30, 'atbezzi', '2016-10-28 16:55:43'),
(31, 'atbezzi', '2016-11-10 09:57:02'),
(32, 'atbezzi', '2016-11-10 15:10:15'),
(33, 'atbezzi', '2016-11-13 20:22:31'),
(34, 'atbezzi', '2016-11-14 15:39:25'),
(35, 'faltamira', '2016-11-14 15:42:15'),
(36, 'atbezzi', '2016-11-14 15:44:08'),
(37, 'atbezzi', '2016-11-14 16:00:25'),
(38, 'atbezzi', '2016-11-14 16:22:20'),
(39, 'atbezzi', '2016-11-19 20:33:10'),
(40, 'atbezzi', '2016-11-19 20:34:04'),
(41, 'atbezzi', '2016-11-19 20:35:40'),
(42, 'atbezzi', '2016-11-19 20:36:18'),
(43, 'atbezzi', '2016-11-19 20:37:01'),
(44, 'atbezzi', '2016-11-29 19:21:54'),
(45, 'atbezzi', '2016-11-30 17:29:03'),
(46, 'secretario', '2016-11-30 18:16:27'),
(47, 'secretario', '2016-11-30 18:21:49'),
(48, 'atbezzi', '2016-11-30 18:22:29'),
(49, 'atbezzi', '2016-11-30 18:22:48'),
(50, 'auditor', '2016-11-30 18:25:06'),
(51, 'administrador', '2016-11-30 18:25:24'),
(52, 'secretario', '2016-11-30 18:26:24'),
(53, 'administrador', '2016-11-30 18:31:55'),
(54, 'tesorero', '2016-11-30 18:34:52'),
(55, 'presidente', '2016-11-30 18:36:08'),
(56, 'cobrador', '2016-11-30 18:36:37'),
(57, 'secretario', '2016-11-30 18:37:59'),
(58, 'administrador', '2016-12-02 20:19:48'),
(59, 'administrador', '2016-12-04 18:37:04'),
(60, 'secretario', '2016-12-04 18:56:24'),
(61, 'administrador', '2016-12-04 19:05:16'),
(62, 'secretario', '2016-12-04 19:14:26'),
(63, 'secretario', '2016-12-07 17:30:24'),
(64, 'administrador', '2016-12-07 18:06:21'),
(65, 'auditor', '2016-12-07 18:36:07'),
(66, 'tesorero', '2016-12-07 18:39:20'),
(67, 'administrador', '2017-01-28 18:14:53'),
(68, 'tesorero', '2017-01-28 18:38:02'),
(69, 'administrador', '2017-01-28 18:38:33'),
(70, 'administrador', '2017-01-28 18:38:33'),
(71, 'administrador', '2017-01-28 18:38:33'),
(72, 'secretario', '2017-01-28 19:17:36'),
(73, 'administrador', '2017-01-28 19:38:01'),
(74, 'administrador', '2017-01-29 16:19:09'),
(75, 'administrador', '2017-01-29 16:53:58'),
(76, 'administrador', '2017-02-06 20:05:16'),
(77, 'administrador', '2017-02-06 20:20:02'),
(78, 'administrador', '2017-02-06 20:21:34'),
(79, 'administrador', '2017-02-06 20:22:44'),
(80, 'administrador', '2017-02-08 19:55:47'),
(81, 'administrador', '2017-02-11 09:10:38'),
(82, 'administrador', '2017-02-12 16:31:01'),
(83, 'secretario', '2017-02-18 15:42:55'),
(84, 'administrador', '2017-02-18 18:26:01'),
(85, 'secretario', '2017-02-18 18:27:19');
...
CREATE TABLE `militares` (
  ...
  `fuerza_id` int(10) UNSIGNED DEFAULT NULL,
  `escalafon_id` int(10) UNSIGNED DEFAULT NULL,
  `promovidopor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `localidadservicio` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `socios` (
  ...
  `nombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `localidadnacimiento` int(10) UNSIGNED NOT NULL,
  `fechanacimiento` date NOT NULL,
  `dni` int(11) NOT NULL,
  `estadocivil` enum('Soltero','Casado','Viudo','Divorciado') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Soltero',
  `sexo` enum('Masculino','Femenino') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Masculino',
  `situacionmilitar` enum('Activo','No activo','No posee') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Activo',
  `grado_id` int(10) UNSIGNED DEFAULT NULL,
  `fuerza_id` int(10) UNSIGNED DEFAULT NULL,
  `escalafon_id` int(10) UNSIGNED DEFAULT NULL,
  `promovidopor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `utilizaembarcadero` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Estructura de tabla para la tabla `socio_cobrador`
--

CREATE TABLE `socio_cobrador` (
  `id` int(10) UNSIGNED NOT NULL,
  `socio_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `solicitudes` (
  `id` int(10) UNSIGNED NOT NULL,
  `tipo` enum('Ingreso','Reingreso','Egreso') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Ingreso',
...
CREATE TABLE `usuarios` (
  ...
  `idaltausuario` varchar(50) DEFAULT NULL,
  `fechaupdate` datetime DEFAULT NULL,
  `idmodificausuario` varchar(50) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `usuarios` (`idusuario`, `usuario`, `clave`, `email`, `activo`, `tipo`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
(3, 'secretario', 'e10adc3949ba59abbe56e057f20f883e', '', 'S', 'S', '2016-11-30 18:14:28', 'atbezzi', '0000-00-00 00:00:00', ''),
(4, 'administrador', 'e10adc3949ba59abbe56e057f20f883e', '', 'S', 'A', '2016-11-30 18:23:27', 'atbezzi', '0000-00-00 00:00:00', ''),
(5, 'tesorero', 'e10adc3949ba59abbe56e057f20f883e', '', 'S', 'T', '2016-11-30 18:23:41', 'atbezzi', '2016-12-07 18:35:34', 'administrador'),
(6, 'auditor', 'e10adc3949ba59abbe56e057f20f883e', '', 'S', 'AU', '2016-11-30 18:23:51', 'atbezzi', '0000-00-00 00:00:00', ''),
(7, 'presidente', 'e10adc3949ba59abbe56e057f20f883e', '', 'S', 'P', '2016-11-30 18:24:06', 'atbezzi', '0000-00-00 00:00:00', ''),
(8, 'elusuario', 'e10adc3949ba59abbe56e057f20f883e', '', 'N', 'C', '2017-01-28 18:46:51', 'administrador', '2017-01-29 17:31:35', 'administrador'),
(9, 'totitos', 'e10adc3949ba59abbe56e057f20f883e', 'to@to.com', 'N', 'A', '2017-01-29 17:30:39', 'administrador', '2017-02-12 19:09:05', 'administrador'),
(10, 'lolos', 'e10adc3949ba59abbe56e057f20f883e', 'lo@lo.com', 'P', 'S', '2017-01-29 18:08:32', 'administrador', '2017-02-08 21:20:21', 'administrador');
...
CREATE TABLE `zonas` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `idaltazona` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `idupdatezona` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `zonas` (`idzona`, `descripcion`, `provincia_id`, `localidad_id`, `barrio`, `created_at`, `idaltazona`, `updated_at`, `idupdatezona`) VALUES
(7, 'Zona 1 bis', 7, 515, 'Norteste', '2017-02-08 23:27:53', 'administrador', '2017-02-11 13:09:41', 'administrador'),
(8, 'Zona 222', 11, 1291, 'Sureste', '2017-02-08 23:36:13', 'administrador', '2017-02-11 13:09:19', 'administrador');
...
ALTER TABLE `categoria_actividad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categoria_actividad_categoria_id_foreign` (`categoria_id`),
  ADD KEY `categoria_actividad_actividad_id_foreign` (`actividad_id`);
...
ALTER TABLE `contactos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contactos_socio_id_foreign` (`socio_id`),
  ADD KEY `contactos_localidad_id_foreign` (`localidad_id`),
  ADD KEY `contactos_zona_id_foreign` (`zona_id`);
...
ALTER TABLE `extensiones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `extensiones_socio_id_foreign` (`socio_id`);
...
ALTER TABLE `localidades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `localidades_provincia_id_foreign` (`id_provincia`);
...
ALTER TABLE `militares`
  ADD PRIMARY KEY (`id`),
  ADD KEY `militares_grado_id_foreign` (`grado_id`),
  ADD KEY `militares_fuerza_id_foreign` (`fuerza_id`),
  ADD KEY `militares_escalafon_id_foreign` (`escalafon_id`),
  ADD KEY `militares_socio_id_foreign` (`socio_id`),
  ADD KEY `militares_localidadservicio_foreign` (`localidadservicio`);
...
ALTER TABLE `socios`
  ...
  ADD KEY `socios_grado_id_foreign` (`grado_id`),
  ADD KEY `socios_fuerza_id_foreign` (`fuerza_id`),
  ADD KEY `socios_escalafon_id_foreign` (`escalafon_id`),
  ADD KEY `socios_localidadservicio_foreign` (`localidadservicio`),
  ADD KEY `socios_estado_id_foreign` (`estado_id`),
...
ALTER TABLE `socio_actividad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `socio_actividad_socio_id_foreign` (`socio_id`),
  ADD KEY `socio_actividad_actividad_id_foreign` (`actividad_id`);

--
-- Indices de la tabla `socio_cobrador`
--
ALTER TABLE `socio_cobrador`
  ADD PRIMARY KEY (`id`),
  ADD KEY `socio_cobrador_socio_id_foreign` (`socio_id`),
  ADD KEY `socio_cobrador_cobrador_id_foreign` (`cobrador_id`);
...
ALTER TABLE `socio_servicio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `socio_servicio_socio_id_foreign` (`socio_id`),
  ADD KEY `socio_servicio_servicio_id_foreign` (`servicio_id`);
...
ALTER TABLE `socio_actividad`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `socio_cobrador`
--
ALTER TABLE `socio_cobrador`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `zonas`
  MODIFY `idzona` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `categoria_actividad`
  ADD CONSTRAINT `categoria_actividad_actividad_id_foreign` FOREIGN KEY (`actividad_id`) REFERENCES `actividades` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `categoria_actividad_categoria_id_foreign` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `cobradores`
  ADD CONSTRAINT `cobradores_zona_id_foreign` FOREIGN KEY (`zona_id`) REFERENCES `zonas` (`idzona`) ON DELETE CASCADE;

--
-- Filtros para la tabla `contactos`
--
ALTER TABLE `contactos`
  ADD CONSTRAINT `contactos_localidad_id_foreign` FOREIGN KEY (`localidad_id`) REFERENCES `localidades` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `contactos_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `contactos_zona_id_foreign` FOREIGN KEY (`zona_id`) REFERENCES `zonas` (`idzona`) ON DELETE CASCADE;

--
-- Filtros para la tabla `extensiones`
--
ALTER TABLE `extensiones`
  ADD CONSTRAINT `extensiones_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `localidades`
--
ALTER TABLE `localidades`
  ADD CONSTRAINT `localidades_provincia_id_foreign` FOREIGN KEY (`id_provincia`) REFERENCES `provincias` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `militares`
--
ALTER TABLE `militares`
  ADD CONSTRAINT `militares_escalafon_id_foreign` FOREIGN KEY (`escalafon_id`) REFERENCES `escalafones` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `militares_fuerza_id_foreign` FOREIGN KEY (`fuerza_id`) REFERENCES `fuerzas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `militares_grado_id_foreign` FOREIGN KEY (`grado_id`) REFERENCES `grados` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `militares_localidadservicio_foreign` FOREIGN KEY (`localidadservicio`) REFERENCES `localidades` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `militares_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `socios`
  ...
  ADD CONSTRAINT `socios_escalafon_id_foreign` FOREIGN KEY (`escalafon_id`) REFERENCES `escalafones` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socios_estado_id_foreign` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socios_fuerza_id_foreign` FOREIGN KEY (`fuerza_id`) REFERENCES `fuerzas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socios_grado_id_foreign` FOREIGN KEY (`grado_id`) REFERENCES `grados` (`id`) ON DELETE CASCADE,
  ...
  ADD CONSTRAINT `socios_localidadservicio_foreign` FOREIGN KEY (`localidadservicio`) REFERENCES `localidades` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `socio_actividad`
--
ALTER TABLE `socio_actividad`
  ADD CONSTRAINT `socio_actividad_actividad_id_foreign` FOREIGN KEY (`actividad_id`) REFERENCES `actividades` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socio_actividad_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `socio_cobrador`
--
ALTER TABLE `socio_cobrador`
  ADD CONSTRAINT `socio_cobrador_cobrador_id_foreign` FOREIGN KEY (`cobrador_id`) REFERENCES `cobradores` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socio_cobrador_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `socio_servicio`
--
ALTER TABLE `socio_servicio`
  ADD CONSTRAINT `socio_servicio_servicio_id_foreign` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `socio_servicio_socio_id_foreign` FOREIGN KEY (`socio_id`) REFERENCES `socios` (`id`) ON DELETE CASCADE;
