						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<h3>Codigo Afiliado: <span class="label label-default"><label id="lbltipo"></label></span></h3><br>
								<h3>Nombre y Apellido Afiliad: <span class="label label-default"><label id="lblnombre"></label></span></h3><br>
								<h3>DNI Afiliad: <span class="label label-default"><label id="lblapellido"></label></span></h3><br>
								<h3>Nombre Embarcacion: <span class="label label-default"><label id="lblnacidoen"></label></span></h3><br>
								<h3>Matricula: <span class="label label-default"><label id="lbllocalidad"></label></span></h3><br>
								<h3>Arboladura: <span class="label label-default"><label id="lblfechanac"></label></span></h3><br>
								<h3>Eslora: <span class="label label-default"><label id="lbldni"></label></span></h3><br>
								<h3>Manga: <span class="label label-default"><label id="lblnomcalle"></label></span></h3><br>
								<h3>Calado: <span class="label label-default"><label id="lblnumcalle"></label></span></h3><br>
								<h3>Marca Motor: <span class="label label-default"><label id="lblpiso"></label></span></h3><br>
								<h3>Potencia: <span class="label label-default"><label id="lbldpto"></label></span></h3><br>
								<h3>Tonelaje: <span class="label label-default"><label id="lblbarrio"></label></span></h3><br>
								<h3>Fecha Ultima Inspeccion: <span class="label label-default"><label id="lblbarrio"></label></span></h3><br>
							  </div>
