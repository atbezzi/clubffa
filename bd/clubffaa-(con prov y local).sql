...
--
-- Servidor: localhost
-- Tiempo de generación: 26-10-2016 a las 23:36:15
...
CREATE TABLE IF NOT EXISTS `avalantes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `avalantes_socio_id_foreign` (`socio_id`),
  KEY `avalantes_socioavala_id_foreign` (`socioavala_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `avalantes`
--
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `incluyemora` enum('Si','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Si',
  ...
  `tipo` enum('Titular','Familiar','Pensionista') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Titular',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `categoria_actividad` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `categoria_actividad_categoria_id_foreign` (`categoria_id`),
  KEY `categoria_actividad_actividad_id_foreign` (`actividad_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `categoria_actividad`
--
...
CREATE TABLE IF NOT EXISTS `categoria_servicio` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `categoria_servicio_categoria_id_foreign` (`categoria_id`),
  KEY `categoria_servicio_servicio_id_foreign` (`servicio_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `categoria_servicio`
--
...
CREATE TABLE IF NOT EXISTS `contactos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `contactos_socio_id_foreign` (`socio_id`),
  KEY `contactos_localidad_id_foreign` (`localidad_id`),
  KEY `contactos_zona_id_foreign` (`zona_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Volcar la base de datos para la tabla `escalafones`
--
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  `estadoanterior` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `estadoposterior` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Volcar la base de datos para la tabla `fuerzas`
--
...
CREATE TABLE IF NOT EXISTS `militares` (
  ...
  `fuerza_id` int(10) unsigned NOT NULL,
  `escalafon_id` int(10) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `militares_grado_id_foreign` (`grado_id`),
  KEY `militares_fuerza_id_foreign` (`fuerza_id`),
  KEY `militares_escalafon_id_foreign` (`escalafon_id`),
  KEY `militares_socio_id_foreign` (`socio_id`),
  KEY `militares_localidadservicio_foreign` (`localidadservicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `militares`
--
...
CREATE TABLE IF NOT EXISTS `socios` (
  ...
  `serviciodesde` date DEFAULT NULL,
  `serviciohasta` date DEFAULT NULL,
  `libro` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `acta` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `socios_grado_id_foreign` (`grado_id`),
  KEY `socios_fuerza_id_foreign` (`fuerza_id`),
  KEY `socios_escalafon_id_foreign` (`escalafon_id`),
  KEY `socios_localidadservicio_foreign` (`localidadservicio`),
  KEY `socios_estado_id_foreign` (`estado_id`),
...
CREATE TABLE IF NOT EXISTS `socio_actividad` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `socio_actividad_socio_id_foreign` (`socio_id`),
  KEY `socio_actividad_actividad_id_foreign` (`actividad_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `socio_actividad`
--
...
CREATE TABLE IF NOT EXISTS `socio_cobrador` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `socio_id` int(10) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `socio_cobrador_socio_id_foreign` (`socio_id`),
  KEY `socio_cobrador_cobrador_id_foreign` (`cobrador_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `socio_cobrador`
--
...
CREATE TABLE IF NOT EXISTS `socio_servicio` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `socio_id` int(10) unsigned NOT NULL,
  `servicio_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `socio_servicio_socio_id_foreign` (`socio_id`),
  KEY `socio_servicio_servicio_id_foreign` (`servicio_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `socio_servicio`
--
...
ALTER TABLE `contactos`
  ...
  ADD CONSTRAINT `contactos_zona_id_foreign` FOREIGN KEY (`zona_id`) REFERENCES `zonas` (`id`) ON DELETE CASCADE;
