		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					...
					<br>
						Referencias:<br>
						<span class="label label-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar embarcación</span>&nbsp;<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Baja embarcación</span>&nbsp;<span class="label label-success"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Ver detalle</span>&nbsp;<span class="label label-warning"><span class="glyphicon glyphicon-qrcode" aria-hidden="true"></span> Generar QR</span>&nbsp;<span class="label label-default"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Editar foto embarcación</span>
						<br><br>
						...
						<table class="table table-striped table-bordered">
							...
							// echo $elsql;
								...
								<tr>
									...
									<a href="consultarembarcacion.php?accion=baja&idembarca=<?php echo $datos['idembarca'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja esta embarcación?')">
									...
									<a href="fotoembarca.php?accion=modifica&idf=<?php echo $datos['idembarca'];?>&close=dor">
