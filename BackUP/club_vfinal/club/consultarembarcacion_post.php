      ...
      function buscar($b) {
			...
			<?php
				...
				<tr>
					...
					<a href="consultarembarcacion.php?accion=baja&idembarca=<?php echo $row['idembarca'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja esta embarcación?')">
