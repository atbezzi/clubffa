		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					...
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="modificartarifas_post.php">
						<div class="col-lg-6 col-md-6 form-group text-left">
							<label for="title" class="col-sm-12 control-label">&nbsp;Categoría: <span class="label label-success"><?php echo $vdescripcion;?></span></label>
						</div><br><br>
