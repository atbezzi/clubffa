...
if (xmlhttp.readyState==4 && xmlhttp.status==200)
{
document.getElementById("myDivNacido").innerHTML=xmlhttp.responseText;
}
}
xmlhttp.open("POST","procnacido.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str);
}
...
function loadmodifica5(str,idl)
{
var xmlhttp;
...
xmlhttp.open("POST","procmodifica5.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str+"&idl="+idl);
}

function loadmodifica6(str,idl)
{
var xmlhttp;
...
xmlhttp.open("POST","procmodifica6.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str+"&idl="+idl);
}

function loadmodifica7(str,idl)
{
var xmlhttp;
...
xmlhttp.open("POST","procmodifica7.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str+"&idl="+idl);
}
...
if (xmlhttp.readyState==4 && xmlhttp.status==200)
{
document.getElementById("myDivCat").innerHTML=xmlhttp.responseText;
}
}
xmlhttp.open("POST","proccate.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str);
}