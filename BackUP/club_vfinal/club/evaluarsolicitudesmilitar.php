	...
	if ($accion =="evaluar")
			{
				...
				INNER JOIN categorias c ON c.id = s.categoria_id WHERE so.id = '$ids'");
			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="evaluarsolicitudes_post.php">
						...
						<input type="hidden" id="emailsocio" name="emailsocio" value="<?php echo $vemail;?>" />
						<input type="hidden" id="apellido" name="apellido" value="<?php echo $vapellido;?>" />
						<input type="hidden" id="nombre" name="nombre" value="<?php echo $vnombre;?>" />
					</form>
				</div>
