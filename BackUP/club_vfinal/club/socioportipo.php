			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="#">
						...
						<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
							<div class="main1">
								<div class="content">
									...
									<div class="alert alert-success" role="alert"><strong>Cantidad de socios por tipo</strong></div>									
										<table class="table table-striped table-bordered">
											...
											<?php 
												...
												$elsql="SELECT tipo, COUNT(nsocio) as cantidad FROM `socios` WHERE estado = 'Activo' or estado = 'Aprobado' GROUP BY tipo";
											...
											// echo $elsql;
												...
												<tr>
													...
													<a href="buscarimprimir.php?accion=imprimir&idp=<?php echo $datos['tipo'];?>&close=dor" target="_blank">
						...
						<?php
						$iiat = 0;
						$resp = mysql_query("SELECT tipo, COUNT(nsocio) as cantidad FROM `socios` WHERE estado = 'Activo' or estado = 'Aprobado' GROUP BY tipo");
						while($datos = mysql_fetch_array($resp)) {
							$array_tipo[$iiat]= $datos['tipo'];
							$array_cant[$iiat]= $datos['cantidad'];
							$iiat = $iiat + 1;
						}
						?>
