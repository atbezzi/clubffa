<?php
	...
	{
		$idfd = $_REQUEST['idfd'];
		$add = mysql_query("delete from foto_embarcacion where id = $idfd");
			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" enctype="multipart/form-data" action="fotoembarca_post.php">
						<div class="col-lg-12 col-md-12 form-group text-left">
								...
								// echo $elsql;
									...
									<tr>
										<td class="text-center">
											<img class="img-rounded" src="foto\embarcaciones\<?php echo $datos['foto'];?>" width="250px" height="250px">
										</td>
										<td class="text-center">
										<span class="label label-danger text-center">
										<a href="fotoembarca.php?accion=baja&idf=<?php echo $idf;?>&idfd=<?php echo $datos['id'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja esta imagen de embarcación?')">
