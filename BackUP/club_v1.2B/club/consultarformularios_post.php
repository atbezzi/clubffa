<?php
      ...
      function buscar($b) {
            ...
            $sql = mysql_query("select f.id as idsolicitud, f.tipo as stipo, s.id as idsoc, s.nsocio, s.nombre, s.apellido, s.tipo, f.estado from solicitudes f inner join socios s on s.id = f.socio_id WHERE s.nombre LIKE '%".$b."%' OR s.apellido LIKE '%".$b."%' OR f.id LIKE '%".$b."%' OR s.nsocio LIKE '%".$b."%' order by f.id" ,$con);
  ...
  function consultar() { 
  	 $con = mysql_connect('localhost','root', '');
            ...
            $sql = mysql_query("select f.id as idsolicitud, f.tipo as stipo, s.id as idsoc, s.nsocio, s.nombre, s.apellido, s.tipo, f.estado from solicitudes f inner join socios s on s.id = f.socio_id order by f.id" ,$con);
