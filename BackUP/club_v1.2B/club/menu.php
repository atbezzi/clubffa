		...
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				...
				<li data-toggle="collapse" data-target="#adminafiliados" class="collapsed">
					<a href="#"><i class="glyphicon glyphicon-stats"></i>&nbsp;Administracion de socios<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				</li>
