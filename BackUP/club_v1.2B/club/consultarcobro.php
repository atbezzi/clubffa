			...
			<div class="main1">
				 <div class="content">
					...
					<input type="text" name="busqueda" class="form-control" id="busqueda" placeholder="Recibo, numero de socio" value="">
						<br>
						Referencias:<br>
						<span class="label label-success"><span class="glyphicon glyphicon-eye-open" aria-hidden="false"></span> Ver detalle</span>&nbsp;<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="false"></span> Anular cobro</span>&nbsp;<span class="label label-primary"><span class="glyphicon glyphicon-print" aria-hidden="false"></span> Imprimir</span>
						<br><br>
						...
						<table class="table table-striped table-bordered">
							...
							// echo $elsql;
								...
								<tr>
									...
									<td class="text-center"><?php echo "$ ".$datos['imptotal'];?></td>
									<td class="text-center"><?php echo $datos['numsocio'];?></td>
									<td class="text-center"><?php echo $datos['nomsocio'].', '.$datos['apellidosocio'];?></td>
