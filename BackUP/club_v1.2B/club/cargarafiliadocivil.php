			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="cargarafiliadocivil_post.php">
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Ocupación:</label>
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Domicilio ocupación:</label>
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Barrio ocupación:</label>
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Provincia ocupación:</label>
							<?php
							$res=mysql_query("select * from provincias");
							?>
