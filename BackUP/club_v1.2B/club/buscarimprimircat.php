								...
								<div class="content">
									<div class="table-responsive">
										<table class="table table-striped table-bordered">
											...
											if ($accion =="imprimir")
													{
													$elsql="select s.nsocio as numsocio, s.categoria_id as categoria, s.nombre as nombre, s.apellido as apellido, s.dni as dni, 
													c.id as idcat, c.descripcion as descripcioncat from socios s inner join categorias c on c.id = s.categoria_id 
													where c.descripcion = '$idp' and s.estado = 'Activo'";
													$select = mysql_query($elsql); 
													// echo $elsql;
													while($datos = mysql_fetch_array($select)) {	
													?>
													<tr>
														<td class="text-center"><?php echo $datos['descripcioncat'];?></td>
