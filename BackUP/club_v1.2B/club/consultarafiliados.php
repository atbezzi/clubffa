			...
			<div class="main1">
				 <div class="content">
					...
					<br>
						...
						<br>
						Referencia:<br>
						<span class="label label-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="false"></span> Editar</span>&nbsp;<span class="label label-success"><span class="glyphicon glyphicon-eye-open" aria-hidden="false"></span> Ver detalle</span>
						<br><br>
