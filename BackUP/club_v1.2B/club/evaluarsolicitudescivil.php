	...
	if ($accion =="evaluar")
			{
				...
				INNER JOIN localidades l4 ON l4.id = c.localidad_id INNER JOIN zonas z ON z.id = s.zona_id INNER JOIN categorias cat ON cat.id = s.categoria_id WHERE so.id = '$ids'");
