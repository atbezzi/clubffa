...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Dar de alta nueva categoria de socio</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="registrarcategorias_post.php">
							...
							<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Nombre de categoría:</label>
							<div class="col-sm-12">
							...
							<input type="checkbox" name="my-checkbox" id="my-checkbox" value="<?php echo $vvoto;?>" data-label-text="Vota" >
							</div>
							</div>
							<div class="col-lg-4 col-md-6 form-group text-center">
