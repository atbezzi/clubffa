...
--
-- Servidor: localhost
-- Tiempo de generación: 15-12-2016 a las 23:17:58
...
CREATE TABLE IF NOT EXISTS `afiliados` (
  ...
  `idmodificausuario` varchar(50) NOT NULL
...
INSERT INTO `afiliados` (`idafiliado`, `nombre`, `apellido`, `dni`, `tipo`, `activo`, `fechaupdate`, `idmodificausuario`) VALUES
(1, 'adrian', 'bezzi', 100000, 'A', 'N', '2016-11-14 16:23:36', 'atbezzi'),
(2, 'fabrizio', 'altamira', 200000, 'H', 'N', '2016-11-14 16:23:16', 'atbezzi');
...
--
-- Volcar la base de datos para la tabla `log_accesos`
--
...
INSERT INTO `usuarios` (`idusuario`, `usuario`, `clave`, `activo`, `tipo`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
...
--
-- Estructura de tabla para la tabla `usuariossys`
--
...
--
-- Volcar la base de datos para la tabla `usuariossys`
--

INSERT INTO `usuariossys` (`id`, `descripcion`) VALUES
(1, 'Administrador'),
(2, 'Secretario'),
(3, 'Presidente'),
(4, 'Auditor'),
