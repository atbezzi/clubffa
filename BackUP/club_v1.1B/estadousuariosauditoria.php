					...
					<br>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered">
								...
								<th class="success">Fecha alta</th>
								<th class="success">Usuario alta</th>
								<th class="success">Fecha última modificación</th>
								<th class="success">Usuario modificación</th>
								</tr>
								<?php 
								...
								// echo $elsql;
									...
									<tr>
										...
										<td><?php if ($datos['tipo']=="Secretario"){
											$tipo = "Secretario";
										} else{
