	...
	if ($accion =="imprimir")
			{
				...
				where c.id = (select ifnull(max(c1.id),0) as maxid from cobros c1 inner join socios s1 on s1.id = c1.socio_id where s1.id = '$idu')";
...
<div id="container">
	...
	<script type="text/javascript">
            function imprimir() {
				...
				//window.close();
				window.location.href = "cargarinscripcion.php";
            }
    </script>
</body>
</html>