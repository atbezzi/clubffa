<?php
      ...
      function buscar($b) {
            ...
            $sql = mysql_query("select id, nsocio, nombre, apellido, tipo from socios WHERE (nombre LIKE '%".$b."%' OR apellido LIKE '%".$b."%' OR nsocio LIKE '%".$b."%') and (estado = 'Aprobado') " ,$con);
			...
			<?php
				...
				<tr>
					...
					<a href="cargarcoinscripcion.php?accion=buscar&idu=<?php echo $row['nsocio'];?>&close=dor">
  ...
  function consultar() { 
  	 $con = mysql_connect('localhost','root', '');
            ...
            $sql = mysql_query("select id, nsocio, nombre, apellido, tipo from socios where estado = 'Aprobado' " ,$con);
