			...
			<div class="main1">
				 <div class="content">
					...
					<input type="text" name="busqueda" class="form-control" id="busqueda" placeholder="Descripción, categoria" value="">
						<br>
						Referencias:<br>
						<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="false"></span> Anular cobro</span>
						<br><br>
							...
							<table class="table table-striped table-bordered">
								...
								<?php 
									...
									<tr>
										...
										<a href="consultarplanes.php?accion=anular&idp=<?php echo $datos['id'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja este plan?')">
