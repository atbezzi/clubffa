...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-search"></span>&nbsp;Consulta de categorías</h2><br>									
						...
						<br><br><br><br>
						Referencias:<br>
						<span class="label label-success"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Activar categorias</span>&nbsp;<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Inactivar categorias</span>&nbsp;<span class="label label-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar categorias</span>
						<br><br>
							...
							<table class="table table-striped table-bordered">
								...
								// echo $elsql;
									...
									<tr>
										...
										&nbsp;&nbsp;
										<a href="consultarcategorias.php?accion=baja&idc=<?php echo $datos['id'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja esta categoría?')">
