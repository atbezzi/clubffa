<?php 
	...
	if($_SESSION['tipo'] != 'Auditor' AND $_SESSION['tipo'] != 'Presidente'){
...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-star-empty"></span>&nbsp;Consulta de cobros</h2><br>
						<div class="col-md-6 form-group text-center">
						<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-search"></span>&nbsp;Número o nombre del socio:</label>
						<div class="col-sm-12">
						  <input type="text" name="busqueda" class="form-control" id="busqueda" placeholder="Número o nombre del socio" value="">	
						</div>
						</div>
						<br><br><br><br>
						<div id='resultado' class="table-responsive">
							<table id="myTable" data-toggle="table" data-detail-view="true" data-detail-formatter="detailFormatter" class="table table-striped table-bordered">
								...
								<?php 
									...
									$elsql="SELECT s.nsocio, s.nombre, s.apellido, c.recibo, c.detalle, c.servicio, c.importe, DATE_FORMAT(c.fechaalta, '%d/%m/%Y') as fechaalta, 
									c.idaltausuario FROM cobros c INNER JOIN socios s ON c.socio_id = s.id ORDER BY s.apellido";
								...
								// echo $elsql;
									...
									<tr>
										...
										<td class="text-center"><?php echo $datos['apellido'].', '.$datos['nombre'];?></td>
										<td class="text-center"><?php echo $datos['recibo'];?></td>
										<td class="text-center"><?php echo $datos['detalle'];?></td>
										<td class="text-center"><?php echo $datos['servicio'];?></td>
	...
	$(document).ready(function(){
        ...
        $("#busqueda").keyup(function(e){
              ...
              $.ajax({
                    type: "POST",
                    url: "estadocobrosauditoria_post.php",
                    data: "b="+consulta,
                    dataType: "html",
                    beforeSend: function(){
                    //imagen de carga
