...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-star-empty"></span>&nbsp;Consulta de socios</h2><br>
						...
						<div id='resultado' class="table-responsive">
							<table id="myTable" data-toggle="table" data-detail-view="true" data-detail-formatter="detailFormatter" class="table table-striped table-bordered">
								...
								<?php 
									...
									$elsql="SELECT s.nsocio, s.nombre, s.apellido, DATE_FORMAT(s.fechaalta, '%d/%m/%Y') as fechaalta, s.idaltausuario, 
									DATE_FORMAT(s.fechaupdate, '%d/%m/%Y') as fechamodifica, s.idmodificausuario from socios s order by s.apellido";
								...
								// echo $elsql;
									...
									<tr>
										...
										<td class="text-center"><?php echo $datos['fechamodifica'];?></td>
	...
	$(document).ready(function(){
        ...
        $("#busqueda").keyup(function(e){
              ...
              $.ajax({
                    type: "POST",
                    url: "estadosociosauditoria_post.php",
                    data: "b="+consulta,
                    dataType: "html",
                    beforeSend: function(){
                    //imagen de carga
