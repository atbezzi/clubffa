...
if (!empty($_POST)){
	...
	$tipoestado="select estado from socios where nsocio = '$vnumsocio'";
    $respuesta2 = mysql_query($tipoestado);
        while($data2 = mysql_fetch_array($respuesta2)) {
            $tipest = $data2['estado'];
        } ;
	...
	$todoOk = 1;
				...
				$add2 = mysql_query("update socios set estado = '$vestado', altapres = '$valtapres', bajapres = '$vbajapres', fechaupdate = NOW(), idmodificausuario = '$vidaltausuario' where nsocio = '$vnumsocio'");
