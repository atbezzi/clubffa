...
/*	if ($accion =="inactiva")
	...
	if ($accion =="modifica")
			{
				$resp = mysql_query("select id, foto, nombre, apellido, dni from familiares where id = $idf");
...
<div id="container">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					...
					<hr>
					<form id="frmcarga" name="frmcarga" method="post" enctype="multipart/form-data" action="fotofamiliar_post.php">
						<div class="col-lg-6 col-md-6 form-group text-left">
							<label for="title" class="col-sm-12 control-label">&nbsp;N° familiar: <span class="label label-success"><?php echo $vidflia;?></span></label>
						...
						<input type="hidden" id="idflia" name="idflia" value="<?php echo $vidflia;?>" />
	...
	$("#foto").fileinput({
		...
		defaultPreviewContent: '<img src="foto/familiar/<?php echo $vfoto;?>" alt="Perfil" style="width:160px"><h6 class="text-muted">Click para seleccionar</h6>',
