			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmbuscar" name="frmbuscar" method="post" action="#">
						...
						<br><br><br>
						Referencias:<br>
						<span class="label label-success"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Editar foto</span>&nbsp;<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Baja familiar</span>&nbsp;<span class="label label-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar familiar</span>
						<br><br>
								...
								// echo $elsql;
									...
									<tr>
										<td class="text-center">
											<img class="img-rounded" src="foto\familiar\<?php echo $datos['foto'];?>" width="75px" height="75px">
										</td>
										<td class="text-center"><?php echo $datos['nombrepariente'];?></td>
										<td class="text-center"><?php echo $datos['dnipariente'];?></td>
										<td class="text-center"><?php echo $datos['fechanacpariente'];?>
										<td class="text-center"><?php echo $datos['parentesco'];?></td>
										<td class="text-center">
										<span class="label label-success text-center">
										<a href="fotofamiliar.php?accion=modifica&idf=<?php echo $datos['id'];?>&close=dor">
										...
										<a href="consultarfamiliar.php?accion=baja&idf=<?php echo $datos['id'];?>&close=dor" onclick="return confirm('¿Esta seguro que desea dar de baja este familiar?')">
