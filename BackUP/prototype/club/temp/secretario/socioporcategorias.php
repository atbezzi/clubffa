				...
				<div class="content">
					...
					<table class="table table-striped table-bordered">
						...
						<?php 
							...
							WHERE c.tipo = 'Civil' and s.estado = 'Activo' or s.estado = 'Aprobado' GROUP BY descripcion";
					...
					<table class="table table-striped table-bordered">
						...
						<?php 
							$usrtarget = $_SESSION['usuario'];
							$elsql="SELECT c.descripcion as descripcion, COUNT(s.id) as cantidad FROM categorias c inner join socios s on s.categoria_id = c.id 
							WHERE c.tipo = 'Militar' and s.estado = 'Activo' or s.estado = 'Aprobado' GROUP BY descripcion";
							$select = mysql_query($elsql); 
						// echo $elsql;
							while($datos = mysql_fetch_array($select)) {	
							?>
					...
					<table class="table table-striped table-bordered">
						...
						<?php 
							$usrtarget = $_SESSION['usuario'];
							$elsql="SELECT c.descripcion as descripcion, COUNT(s.id) as cantidad FROM categorias c inner join socios s on s.categoria_id = c.id 
							WHERE c.tipo = 'Pensionista' and s.estado = 'Activo' or s.estado = 'Aprobado' GROUP BY descripcion";
							$select = mysql_query($elsql); 
						// echo $elsql;
							while($datos = mysql_fetch_array($select)) {	
							?>
