	...
	$todoOk = 1;
		...
		while($datos = mysql_fetch_array($resp)) {
			$elmaximo = $datos['maxid'];
				...
				values('$elmaximo','$vnombreemb','$varboladura','$vcasco','$veslora','$vmanga','$vpuntal','$vcalado','$vtonelaje','$vmarcamotor','$vnumeromotor','$vpotmotor','$vmatricula','$vrey','$vfechainsp','$velementos',(SELECT id FROM socios WHERE $vcodigosocio = nsocio and estado = 'Activo'),NOW(),'$vusuariocarga')");
				if($add){
