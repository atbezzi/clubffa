								...
								<div class="content">
									<div class="table-responsive">
										<table class="table table-striped table-bordered">
											...
											if ($accion =="imprimir")
													{
													$elsql="select p.recibo as recibo, p.importe as importetotal, DATE_FORMAT(p.fechapago,'%m/%Y') as fechapago, s.nsocio as nsocio, 
													s.nombre as nombre, s.apellido as apellido from cobros p inner join socios s on s.id = p.socio_id 
													where DATE_FORMAT(p.fechapago,'%m/%Y') = '$idp' order by p.fechapago asc";
													...
													<tr>
														...
														<td class="text-right"><?php echo "$".$datos['importetotal'];?></td>
