...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Solicitud de ingreso para socio civil</h2>
					<hr>
					<form id="frmcarga" name="frmcarga" method="post" action="cargarafiliadocivil_post.php">
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Profesión:</label>
							<input type="text" name="ocupacion" class="form-control" id="ocupacion" placeholder="Introduce una ocupacion" value="<?php echo $vocupaion;?>">
						</div>
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Domicilio profesional:</label>
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Barrio profesional:</label>
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Provincia profesional:</label>
							<?php
							$res=mysql_query("select * from provincias");
							?>
						...
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Localidad profesional:</label>
																														...
																														if(document.getElementById("ocupacion").value.trim() != ""){
																															if(document.getElementById("domiciocupa").value.trim() != ""){
																																if(document.getElementById("barrioocupa").value.trim() != ""){
																																	if(document.getElementById("provocupa").value.trim() != ""){
																																		if(document.getElementById("localidadocupa").value.trim() != ""){
