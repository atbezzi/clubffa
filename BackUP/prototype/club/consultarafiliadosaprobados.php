...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2>Consulta de socio aprobados</h2>
					<br>
						...
						<div id='resultado' class="table-responsive">
						 <table class="table table-striped table-bordered">
							...
							<?php 
								...
								$elsql="select id, nsocio, foto, nombre, apellido, tipo from socios where estado = 'Aprobado'";
	...
	$(document).ready(function(){
        ...
        $("#busqueda").keyup(function(e){
              ...
              $.ajax({
                    type: "POST",
                    url: "consultarafiliadosaprobados_post.php",
                    data: "b="+consulta,
                    dataType: "html",
                    beforeSend: function(){
                    //imagen de carga
