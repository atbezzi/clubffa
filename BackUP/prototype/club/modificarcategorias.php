...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Modificar categoría</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="modificarcategorias_post.php">
							...
							<div class="col-sm-12">
							  <input type="text" name="impinsc" class="form-control text-right" id="impinsc" onkeydown="return validarNumeros(event)" placeholder="Introduce un importe de inscripcion" value="<?php echo $vimpinsc;?>">
							</div>
							</div>
							<div class="col-lg-4 col-md-6 form-group text-center">
