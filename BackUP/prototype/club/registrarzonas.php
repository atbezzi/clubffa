...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Registrar zona</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="registrarzonas_post.php">
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Nombre de la zona:</label>
						<div class="col-sm-12">
						  <input type="text" name="zona" class="form-control" id="zona" placeholder="Introduce un nombre de la zona" value="<?php echo $vdescripcion;?>">
						</div>
						</div>
						<div class="col-lg-4 col-md-6 form-group text-center">
						...
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Localidad:</label>
							<select type="text" name="localidad" class="form-control" id="localidad" placeholder="Introduce la localidad" value="<?php echo $vlocalidad_id;?>"></select>
						</div>
