<?php 
	...
	if($_SESSION['tipo'] != 'Secretario' AND $_SESSION['tipo'] != 'Presidente' AND $_SESSION['tipo'] != 'SA'){
			...
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-star-empty"></span>&nbsp;Consulta de formularios</h2><br>
						...
						<label for="title" class="col-sm-12 control-label"><span class="glyphicon glyphicon-search"></span>&nbsp;Solicitud, número o nombre del socio:</label>
						<div class="col-sm-12">
						...
						<br><br><br><br>
						Referencia:<br>
						<span class="label label-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="false"></span> Ver detalle</span>
						<br><br>
						<div id='resultado' class="table-responsive">
							<table id="myTable" data-toggle="table" data-detail-view="true" data-detail-formatter="detailFormatter" class="table table-striped table-bordered">
								<tr>
								<th class="success text-center">Numero de solicitud</th>
								...
								<th class="success text-center">Tipo de solcitud</th>
								<th class="success text-center">Estado de la solicitud</th>
								<th class="success text-center">Ver+</th>
								</tr>
								<?php 
									$usrtarget = $_SESSION['usuario'];
									$elsql="select f.id as idsolicitud, f.tipo as stipo, s.id as idsocio, s.nsocio, s.nombre, s.apellido, s.tipo, f.estado from solicitudes f inner join socios s on s.id = f.socio_id order by f.id";
									$select = mysql_query($elsql);
								// echo $elsql;
									while($datos = mysql_fetch_array($select)) {
									?>
									<tr>
										<td class="text-center"><?php echo $datos['idsolicitud'];?></td>
										...
										<td class="text-center"><?php echo $datos['stipo'];?></td>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								...
								<h3>Número de socio: <span class="label label-primary"><label id="lblnumero"></label></span></h3><hr>
