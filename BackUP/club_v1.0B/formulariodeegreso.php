			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="formulariodeegreso_post.php">
						...
						<div class="col-sm-12">
						  <input type="text" name="busqueda" class="form-control" id="busqueda" onkeydown="return validarNumeros(event)" placeholder="Introduce un codigo de afiliado" value="<?php echo $vcodigoafilia;?>">
						</div>
