...
/*	if ($accion =="inactiva")
	...
	if ($accion =="modifica")
			{
				$resp = mysql_query("select * from afiliados where idafiliado = $idm");
			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="registrarembarcacion_post.php">
						...
						<div class="col-lg-4 col-md-6 form-group text-center">
						<label for="title" class="control-label"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Numero Motor:</label>
						...
						<div class="col-sm-12">
							...
							<textarea class="form-control" rows="5" style="overflow:auto;resize:none" name="elementos" id="elementos" placeholder="Introduce un elementos" value="<?php echo $velementos;?>"></textarea>
						</div>
