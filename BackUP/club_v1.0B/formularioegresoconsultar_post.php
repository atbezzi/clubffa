      ...
      function buscar($b) {
       ...
       if($contar > 0)
            ...
            while($row=mysql_fetch_array($sql))
              ...
              $dni = $row['dni'] ;
              ?>
              <label for="title" class="col-sm-12 control-label">&nbsp;Nombre de Afiliado: <?php echo $nombre ?> </label>
              <label for="title" class="col-sm-12 control-label">&nbsp;Apellido de Afiliado: <?php echo $apellido ?></label>  
              <label for="title" class="col-sm-12 control-label">&nbsp;DNI de Afiliado: <?php echo $dni ?></label>
                <?php  
              }
            }
        else
