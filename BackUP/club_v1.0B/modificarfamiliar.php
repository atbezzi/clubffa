			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="modificarfamiliar_post.php">
						...
						<div class="col-sm-12">
						  <input type="text" name="codigoafilia" class="form-control" id="codigoafilia" onkeydown="return validarNumeros(event)" placeholder="Introduce un codigo de afiliado" value="<?php echo $vcodigoafilia;?>" disabled="disabled">
						</div>
						</div>
						<div class="col-lg-4 col-md-6 form-group text-center">
