			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmcarga" name="frmcarga" method="post" action="evaluarsolicitudes_post.php">
						...
						<h3>Ocupacion: <span class="label label-primary"><?php echo $vocupacion;?></span></h3><hr>
						<h3>Domicilio Ocupacion: <span class="label label-primary"><?php echo $vdomiciocupa;?></span></h3><hr>
						<h3>Barrio Ocupacion: <span class="label label-primary"><?php echo $vbarrioocupa;?></span></h3><hr>
						<h3>Localidad Ocupacion: <span class="label label-primary"><?php echo $vlocalidadocupa;?></span></h3>
						<?php
							if ($vtiposol == 'Egreso'){
									?>
									<hr>
