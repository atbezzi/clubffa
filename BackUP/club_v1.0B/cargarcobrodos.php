...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Cargar Cobro Paso Dos</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post">
						<div class="col-lg-6 col-md-6 form-group text-left">
							<label for="title" class="col-sm-12 control-label">&nbsp;Numero de Afiliado: <span class="label label-success"><?php echo $vnsocio;?></span></label>
							<label for="title" class="col-sm-12 control-label">&nbsp;Nombre de Afiliado: <span class="label label-success"><?php echo $vnombre;?></span></label>
							<label for="title" class="col-sm-12 control-label">&nbsp;Apellido de Afiliado: <span class="label label-success"><?php echo $vapellido;?></span></label>	
							<label for="title" class="col-sm-12 control-label">&nbsp;DNI de Afiliado: <span class="label label-success"><?php echo $vdni;?></span></label>
