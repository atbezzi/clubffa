<?php
	...
	if ($accion =="modifica")
			{
				$resp = mysql_query("select * from usuarios where id = $idu");
...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					<h2><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;Modificar Usuarios</h2>
					<br>
					<form id="frmcarga" name="frmcarga" method="post" action="modificarusuarios_post.php">
						<div class="col-sm-6 text-center">
							...
							<div class="col-sm-12">
							  <input type="password" name="clave" class="form-control" id="clave" placeholder="Introduce un nueva clave" value="">
							</div>
							</div>
							<div class="form-group">
