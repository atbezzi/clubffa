...
if (!empty($_POST)){
	...
	$todoOk = 1;
				...
				$add = mysql_query("UPDATE socios SET nombre = '$vnombre', apellido = '$vapellido', localidadnacimiento = '$vlocalidad', fechanacimiento = '$vfechanac', dni = '$vdni', 
				...
				$add2 = mysql_query("UPDATE sociosc SET ocupacion = '$vocupacion', domicilio = '$vdomiciocupa', barrio = '$vbarrioocupa', 
				localidad_id = '$vlocalidadocupa', fechaupdate = NOW(), idmodificausuario = '$vidaltausuario' WHERE socio_id = '$idu'");
