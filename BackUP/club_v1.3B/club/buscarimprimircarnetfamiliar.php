							...
							<div class="main1">
								<div class="content">						
									...
									if ($accion =="imprimir")
											...
											p.descripcion as plan, ps.vencimiento from plan_socio_familiar psf inner join familiares f on f.id = psf.familiar_id 
											...
											?>
												<div class="css-shapes-preview">
													...
													&nbsp;<img class="img-rounded" src="foto\socio\familiar.jpg" width="50px" height="50px">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Club FFAA - Córdoba &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
