<?php 
	...
	if ($accion == "baja")
			{
				$add = mysql_query("update planes set estado ='No activo', fechaupdate = NOW(), idmodificausuario = '$vidmodificausuario' where id = $idp");
				if($add){
					header("location:consultarplancuota.php?retorno=Inactivado correctamente");
				}else{
					header("location:consultarplancuota.php?retorno=" .mysql_error());
				}
			}
...
<div id="container">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				 <div class="content">
					...
					<br>
					<input type="text" name="busqueda" class="form-control" id="busqueda" placeholder="Descripción o categoría" value="">	
					<br>
						Referencias:<br>
						<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Baja de plan</span>
						<br><br>
						...
						<table class="table table-striped table-bordered">
							...
							<?php 
								...
								$elsql="select p.id as idplan, p.descripcion, c.descripcion as categoria, p.cantidad_familiar as familiares, p.cantidad_cuota as cuotas, p.importe 
								from planes p inner join categorias c on c.id = p.categoria_id where p.estado = 'Activo'";
							...
							// echo $elsql;
								...
								<tr>
									...
									<td class="text-center"><?php echo $datos['familiares'];?></td>
									<td class="text-center"><?php echo $datos['cuotas'];?></td>
									<td class="text-center"><?php echo $datos['importe'];?></td>
									<td class="text-center">
									<span class="label label-danger text-center">
									<a href="consultarplancuota.php?accion=baja&idp=<?php echo $datos['idplan'];?>&close=dor">
	...
	$(document).ready(function(){
        ...
        $("#busqueda").keyup(function(e){
              ...
              $.ajax({
                    type: "POST",
                    url: "consultarplancuota_post.php",
                    data: "b="+consulta,
                    dataType: "html",
                    beforeSend: function(){
                    //imagen de carga
