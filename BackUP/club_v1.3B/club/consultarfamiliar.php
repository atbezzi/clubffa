			...
			<div class="main1">
				<div class="content">
					...
					<form id="frmbuscar" name="frmbuscar" method="post" action="buscarparientes_post.php">
						...
						<br><br><br>
						Referencias:<br>
						<span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Baja familiar</span>&nbsp;<span class="label label-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar familiar</span>
						<br><br>
