	...
	<i class="toggle-btn" data-toggle="collapse" data-target="#menu-content"><span class="glyphicon glyphicon-align-justify"></span></i>
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				...
				<li <?=echoActiveClassIfRequestMatches("consultarafiliados")?>><a href="consultarafiliados.php">&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-search"></span>&nbsp;Consulta de socios</a></li>
				...
				<li data-toggle="collapse" data-target="#plancuota" class="collapsed">
					<a href="#">&nbsp;<i class="glyphicon glyphicon-usd"></i>&nbsp;Planes de cuota<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				</li>
				<ul class="sub-menu collapse" id="plancuota">
				<li <?=echoActiveClassIfRequestMatches("registrarplancuota")?>><a href="registrarplancuota.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-floppy-save"></span>&nbsp;Registrar</a></li>
				<li <?=echoActiveClassIfRequestMatches("consultarplancuota")?>><a href="consultarplancuota.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-search"></span>&nbsp;Consultar</a></li>
				</ul>
				</ul>
				...
				<li data-toggle="collapse" data-target="#cuotas" class="collapsed">
					<a href="#"><i class="glyphicon glyphicon-usd"></i>&nbsp;Planes sociales<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				</li>
				...
				<li <?=echoActiveClassIfRequestMatches("cargarcobro")?>><a href="cargarcobro.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-floppy-save"></span>&nbsp;Planes</a></li>
				<li <?=echoActiveClassIfRequestMatches("cargarinscripcion")?>><a href="cargarinscripcion.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-right:5px; padding-top:10px;" class="glyphicon glyphicon-floppy-save"></span>&nbsp;Inscripción</a></li>
