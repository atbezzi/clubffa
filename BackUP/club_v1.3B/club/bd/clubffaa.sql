...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2017 a las 23:02:45
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CUOTAS_CREATE` (IN `pcantidad` INT, IN `pimporte` DECIMAL(11,2))  NO SQL
BEGIN
DECLARE i int DEFAULT 1;
WHILE i <= pcantidad DO
	INSERT INTO cuotas (plan_socio_id, periodo, importe, vencimiEnto)
	VALUES ((SELECT MAX(id) AS idp_s FROM plan_socio), DATE_ADD( NOW(), INTERVAL (i-1) MONTH ), pimporte, DATE_ADD( NOW(), INTERVAL (i) MONTH ));
    SET i = i +1;
END WHILE;
END$$
...
CALL SP_CUOTAS_CREATE(pcantidad,pimporte);
END$$
...
(1, 'Militar Activo', 'MA', 'Si', '25000.00', '5000.00', '1600.00', 10, 10, 'Militar', 'Activo', '2017-05-17', 'administrador', '2017-06-14', 'tesorero'),
...
(6, 'Civil Transeunte', 'CT', 'No', '25000.00', '4500.00', '2000.00', 1, 10, 'Civil', 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
...
(1, 1, 'SANCHO', 'MOHAMED SAIZ ', 58933285, 'Soltero', 'Masculino', 'San Luis 466', 784, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(2, 2, 'JOSE LUIS', 'PERNAS', 3371399, 'Soltero', 'Masculino', 'Padre Lozano 349', 645, 'Activo', '2017-05-17', 'administrador', '2017-06-14', 'administrador'),
(3, 3, 'CRISTIAN', 'COROMINAS FERRI', 24851803, 'Soltero', 'Masculino', 'JosÃ© Saravia 4249', 732, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(4, 4, 'MIGUEL ANGEL', 'MELGAREJO SEBASTIA', 43598048, 'Soltero', 'Masculino', 'Valencia 1776', 623, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(5, 5, 'ANDRES', 'INFANTES CORDOBA', 63826020, 'Soltero', 'Masculino', 'Dr. Antolin Torres 3674', 698, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(6, 6, 'JOSE MARIA ', 'IZAGUIRRE CHAVEZ', 16825358, 'Soltero', 'Masculino', 'Kansas 1757', 781, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(7, 8, 'EDUARDO ', 'MORA DEL RIO', 60209569, 'Soltero', 'Masculino', 'Av. Gral. Paz 142 7B', 737, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(8, 8, 'ROSARIO', 'ACEVEDO MAYOR', 83863848, 'Soltero', 'Masculino', 'Av. Duarte QuirÃ³s 92 5C', 720, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(9, 7, 'ENRIQUE', 'PALMER', 50910698, 'Soltero', 'Masculino', '  Arturo Illia 9699', 765, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(10, 9, 'ISMAEL', 'GAMERO ARNAU', 83283124, 'Soltero', 'Masculino', 'Rosario 130', 736, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(11, 10, 'LUIS MIGUEL', 'PERNAS', 60432824, 'Soltero', 'Masculino', 'Rafael Lozada 202', 797, 'Activo', '2017-05-17', 'administrador', '0000-00-00', '');
...
INSERT INTO `cuotas` (`id`, `plan_socio_id`, `periodo`, `importe`, `vencimiento`, `estado`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
(1, 4, '2017-07-14', '200.00', '2017-08-14', 'Pendiente', NULL, NULL, NULL, NULL),
(2, 4, '2017-08-14', '200.00', '2017-09-14', 'Pendiente', NULL, NULL, NULL, NULL),
(3, 5, '2017-07-14', '5000.00', '2017-08-14', 'Pendiente', NULL, NULL, NULL, NULL),
(4, 5, '2017-08-14', '5000.00', '2017-09-14', 'Pendiente', NULL, NULL, NULL, NULL),
(5, 6, '2017-07-14', '8200.00', '2017-08-14', 'Pendiente', NULL, NULL, NULL, NULL),
(6, 6, '2017-08-14', '8200.00', '2017-09-14', 'Pendiente', NULL, NULL, NULL, NULL),
(7, 6, '2017-09-14', '8200.00', '2017-10-14', 'Pendiente', NULL, NULL, NULL, NULL),
(8, 6, '2017-10-14', '8200.00', '2017-11-14', 'Pendiente', NULL, NULL, NULL, NULL),
(9, 6, '2017-11-14', '8200.00', '2017-12-14', 'Pendiente', NULL, NULL, NULL, NULL),
(10, 6, '2017-12-14', '8200.00', '2018-01-14', 'Pendiente', NULL, NULL, NULL, NULL),
(11, 6, '2018-01-14', '8200.00', '2018-02-14', 'Pendiente', NULL, NULL, NULL, NULL),
(12, 6, '2018-02-14', '8200.00', '2018-03-14', 'Pendiente', NULL, NULL, NULL, NULL),
(13, 6, '2018-03-14', '8200.00', '2018-04-14', 'Pendiente', NULL, NULL, NULL, NULL),
(14, 6, '2018-04-14', '8200.00', '2018-05-14', 'Pendiente', NULL, NULL, NULL, NULL),
(15, 6, '2018-05-14', '8200.00', '2018-06-14', 'Pendiente', NULL, NULL, NULL, NULL),
(16, 6, '2018-06-14', '8200.00', '2018-07-14', 'Pendiente', NULL, NULL, NULL, NULL);
...
(1, 'Velero Angel', 'Velero', '1.2', '7.90', '1.50', '2.00', '2.00', '2000.00', 'Nanni', 20, '15.00', 'A342F999', '613008540', '2017-01-15', 'Garrafa, Lona, TV 32'' Mesa, Cama', 1, 'Activo', '2017-05-19', 'secretario', '2017-06-14', 'secretario'),
(2, 'Yate Torralba I', 'Yate', '1.1', '5.00', '2.10', '2.20', '2.50', '1500.00', 'Nanni', 15, '20.00', 'A334F261', '65019774', '2017-02-10', 'Lona, 2 Garrafa', 2, 'Activo', '2017-05-19', 'secretario', NULL, NULL),
(3, 'Yate Torralba II', 'Yate', '1.1', '5.00', '2.10', '2.20', '2.50', '1500.00', 'Nanni', 15, '20.00', 'A419C613', '11963018', '2016-09-15', 'No posee', 2, 'Activo', '2017-05-19', 'secretario', NULL, NULL);
...
INSERT INTO `familiares` (`id`, `socio_id`, `nombre`, `apellido`, `dni`, `fechanacimiento`, `parentesco`, `estado`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
(1, 1, 'MARCELO', 'REVUELTA YANES', 90360576, '1990-06-10', 'Hijo', 'Activo', '2017-05-20', 'secretario', '2017-06-26', 'secretario'),
(2, 1, 'LAURA', 'BARRIOS', 3265442, '1978-12-05', 'Conyuge', 'Activo', '2017-06-26', 'secretario', NULL, NULL),
(3, 3, 'MARIA ANGEL', 'GUEDES VILCHES', 354654564, '1985-07-10', 'Hijo', 'Activo', '2017-06-26', 'secretario', NULL, NULL),
(4, 9, 'ARTURO', 'VICENS ESPINOSA', 23423424, '1987-11-10', 'Hijo', 'Activo', '2017-06-26', 'secretario', NULL, NULL);
...
CREATE TABLE `inscripciones` (
  ...
  `importe` decimal(11,2) NOT NULL,
  `estado` enum('Pendiente','Pagado','Anulado') COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'Pendiente',
  `fechaalta` date DEFAULT NULL,
  `idaltausuario` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `fechaupdate` date DEFAULT NULL,
  `idmodificausuario` varchar(255) COLLATE utf8_spanish2_ci DEFAULT NULL
...
(113, 'tesorero', '2017-05-31 17:43:41'),
(114, 'tesorero', '2017-06-02 16:36:59'),
(115, 'tesorero', '2017-06-02 19:42:00'),
(116, 'tesorero', '2017-06-05 17:26:47'),
(117, 'tesorero', '2017-06-06 17:25:12'),
(118, 'secretario', '2017-06-06 17:30:58'),
(119, 'tesorero', '2017-06-06 17:35:59'),
(120, 'secretario', '2017-06-08 19:00:28'),
(121, 'tesorero', '2017-06-08 19:07:52'),
(122, 'secretario', '2017-06-08 19:37:52'),
(123, 'tesorero', '2017-06-09 16:50:09'),
(124, 'secretario', '2017-06-09 17:44:32'),
(125, 'tesorero', '2017-06-09 18:46:14'),
(126, 'secretario', '2017-06-09 19:05:00'),
(127, 'tesorero', '2017-06-10 17:03:15'),
(128, 'administrador', '2017-06-13 18:11:19'),
(129, 'secretario', '2017-06-13 18:13:50'),
(130, 'presidente', '2017-06-13 18:16:16'),
(131, 'tesorero', '2017-06-13 18:16:31'),
(132, 'administrador', '2017-06-13 18:23:27'),
(133, 'secretario', '2017-06-13 18:23:58'),
(134, 'tesorero', '2017-06-13 18:24:33'),
(135, 'administrador', '2017-06-14 17:47:19'),
(136, 'secretario', '2017-06-14 17:59:17'),
(137, 'tesorero', '2017-06-14 18:37:31'),
(138, 'presidente', '2017-06-14 18:47:31'),
(139, 'auditor', '2017-06-14 18:52:48'),
(140, 'secretario', '2017-06-14 18:58:48'),
(141, 'administrador', '2017-06-14 19:12:59'),
(142, 'administrador', '2017-06-14 19:14:29'),
(143, 'secretario', '2017-06-14 19:18:28'),
(144, 'tesorero', '2017-06-16 16:32:31'),
(145, 'secretario', '2017-06-16 16:38:12'),
(146, 'presidente', '2017-06-16 16:45:19'),
(147, 'secretario', '2017-06-16 16:48:03'),
(148, 'presidente', '2017-06-16 16:53:06'),
(149, 'secretario', '2017-06-16 16:54:28'),
(150, 'presidente', '2017-06-16 17:01:18'),
(151, 'secretario', '2017-06-16 17:01:45'),
(152, 'presidente', '2017-06-16 17:06:51'),
(153, 'presidente', '2017-06-16 17:10:30'),
(154, 'secretario', '2017-06-16 17:10:41'),
(155, 'presidente', '2017-06-16 17:11:30'),
(156, 'secretario', '2017-06-16 17:13:08'),
(157, 'presidente', '2017-06-16 17:16:03'),
(158, 'secretario', '2017-06-16 17:26:35'),
(159, 'presidente', '2017-06-16 17:27:11'),
(160, 'secretario', '2017-06-16 17:30:06'),
(161, 'presidente', '2017-06-16 17:37:14'),
(162, 'secretario', '2017-06-16 17:37:33'),
(163, 'presidente', '2017-06-16 17:41:52'),
(164, 'administrador', '2017-06-17 21:46:58'),
(165, 'secretario', '2017-06-17 21:50:07'),
(166, 'presidente', '2017-06-17 21:56:07'),
(167, 'tesorero', '2017-06-17 21:56:26'),
(168, 'tesorero', '2017-06-21 17:47:58'),
(169, 'presidente', '2017-06-21 18:23:10'),
(170, 'secretario', '2017-06-21 18:32:47'),
(171, 'presidente', '2017-06-21 18:33:31'),
(172, 'secretario', '2017-06-21 18:35:35'),
(173, 'presidente', '2017-06-22 16:19:10'),
(174, 'secretario', '2017-06-22 16:19:19'),
(175, 'administrador', '2017-06-25 15:09:41'),
(176, 'secretario', '2017-06-25 15:16:41'),
(177, 'secretario', '2017-06-25 15:39:13'),
(178, 'tesorero', '2017-06-25 15:40:54'),
(179, 'tesorero', '2017-06-25 15:42:21'),
(180, 'secretario', '2017-06-25 15:46:02'),
(181, 'secretario', '2017-06-25 17:59:29'),
(182, 'presidente', '2017-06-25 18:00:15'),
(183, 'tesorero', '2017-06-25 18:32:26'),
(184, 'secretario', '2017-06-26 17:23:18'),
(185, 'presidente', '2017-06-26 18:33:53'),
(186, 'secretario', '2017-06-27 17:23:56'),
(187, 'tesorero', '2017-06-27 17:43:10'),
(188, 'secretario', '2017-06-27 18:01:13'),
(189, 'tesorero', '2017-06-27 18:29:06'),
(190, 'administrador', '2017-06-27 18:32:25'),
(191, 'secretario', '2017-06-27 18:35:35'),
(192, 'presidente', '2017-06-27 18:36:07'),
(193, 'administrador', '2017-06-27 18:36:52'),
(194, 'tesorero', '2017-06-27 18:48:49'),
(195, 'tesorero', '2017-06-27 19:02:44'),
(196, 'tesorero', '2017-06-28 17:48:24'),
(197, 'secretario', '2017-06-28 18:54:00'),
(198, 'tesorero', '2017-07-01 16:07:32'),
(199, 'tesorero', '2017-07-01 18:12:48'),
(200, 'secretario', '2017-07-02 16:14:07'),
(201, 'secretario', '2017-07-03 03:01:06'),
(202, 'secretario', '2017-07-03 17:28:44'),
(203, 'secretario', '2017-07-05 18:05:42'),
(204, 'secretario', '2017-07-06 17:27:42'),
(205, 'tesorero', '2017-07-06 17:30:42'),
(206, 'secretario', '2017-07-06 19:24:39'),
(207, 'tesorero', '2017-07-06 20:03:58'),
(208, 'tesorero', '2017-07-07 16:31:04'),
(209, 'secretario', '2017-07-07 19:51:22'),
(210, 'secretario', '2017-07-11 18:25:48'),
(211, 'tesorero', '2017-07-13 19:13:56');
...
CREATE TABLE `planes` (
  ...
  `cantidad_cuota` int(11) NOT NULL,
  `importe` decimal(11,2) NOT NULL,
...
INSERT INTO `planes` (`id`, `descripcion`, `categoria_id`, `cantidad_familiar`, `cantidad_cuota`, `importe`, `estado`, `fechaalta`, `idaltausuario`, `fechaupdate`, `idmodificausuario`) VALUES
(4, 'Plan MA anual', 1, 2, 12, '8200.00', 'Activo', NULL, NULL, NULL, NULL),
(5, 'Plan MC semestral', 2, 1, 6, '7000.00', 'Activo', NULL, NULL, NULL, NULL),
(6, 'Plan CC anual', 5, 1, 12, '9500.00', 'Activo', NULL, NULL, NULL, NULL),
(7, 'Plan CT anual', 6, 0, 12, '4500.00', 'Activo', NULL, NULL, NULL, NULL),
(8, 'Plan P anual', 7, 2, 12, '7000.00', 'Activo', NULL, NULL, NULL, NULL);
...
(1, 4, 1, '2018-07-13', 'Pendiente', NULL, NULL, NULL, NULL),
(4, 5, 7, '2018-01-13', 'Pendiente', NULL, NULL, NULL, NULL),
(5, 4, 1, '2018-07-14', 'Pendiente', NULL, NULL, NULL, NULL),
(6, 4, 1, '2018-07-14', 'Pendiente', NULL, NULL, NULL, NULL);
...
(1, '101', 'default.jpg', 'ANGEL', 'REVUELTA YANES', 295, '1850-03-06', 58504888, 'Casado', 'Masculino', 'Justo Jose 135', 'Alta Cordoba', 543, 5000, '680 575 312', '4539 7619', 'RAngel@email.com', 'Club', 'Justo Jose 135', 'Alta Cordoba', 543, 2, 'M1', '100', 'Militar', 1, 'Si', 'Activo', '2016-12-10', NULL, '2017-05-17', 'secretario', '2017-07-03', 'secretario'),
(2, '102', 'default.jpg', 'IGNACIO', 'ALIAGA TORRALBA', 790, '1956-01-20', 43365748, 'Viudo', 'Masculino', '  Esteban Bonorino 4638', 'Villa Rivadavia', 543, 5000, ' 666 952 668', ' 4556 7543', 'ATIgnacio@email.com', 'Club', '  Esteban Bonorino 4638', 'Villa Rivadavia', 543, 6, 'M1', '100', 'Militar', 1, 'Si', 'Inactivo', '2016-12-10', '2017-05-10', '2017-05-17', 'secretario', '2017-06-26', 'presidente'),
(3, '103', '103.jpg', 'MIGUEL ANGEL', 'GUEDES VILCHES', 303, '1955-02-25', 18915434, 'Casado', 'Masculino', 'RÃ­o de CajÃ³n 1252', 'Los Olmos', 543, 5000, '609 267 187', '4485 2598', 'GVMAngel@email.com', 'Club', 'RÃ­o de CajÃ³n 1252', 'Los Olmos', 543, 4, 'M1', '103', 'Militar', 2, 'Si', 'Activo', '2017-01-10', NULL, '2017-05-17', 'secretario', '2017-05-19', 'presidente'),
(4, '104', 'default.jpg', 'OSCAR', 'PUJOL SAUCEDO', 790, '1949-12-12', 49197666, 'Casado', 'Masculino', 'Buenos Aires 971 2B', 'Nueva CÃƒÂ³rdoba', 543, 5000, '760 813 890', '4485 7413', 'PSOscar@email.com', 'Club', 'Buenos Aires 971 2B', 'Nueva CÃƒÂ³rdoba', 543, 8, 'C1', '100', 'Civil', 5, 'Si', 'Inactivo', '2017-01-10', '2017-05-10', '2017-05-19', 'secretario', '2017-06-26', 'presidente'),
(5, '105', 'default.jpg', 'FELIX', 'VELARDE MELERO', 1306, '1961-05-06', 18128819, 'Viudo', 'Masculino', 'Av. PueyrredÃ³n 216 5D', 'Nueva CÃ³rdoba', 543, 5000, ' 788 410 356', '4532 1757', 'VMFelix@email.com', 'Club', 'Av. PueyrredÃ³n 216 5D', 'Nueva CÃ³rdoba', 543, 8, 'M1', '101', 'Militar', 1, 'Si', 'Activo', '2017-01-10', NULL, '2017-05-19', 'secretario', '2017-06-16', 'presidente'),
(6, '106', 'default.jpg', 'DAVID BLANCO', 'FONTAN', 543, '1959-10-08', 46832056, 'Casado', 'Masculino', 'Mariano Fragueiro 4454', 'Juan B. Justo', 543, 5000, '771 234 706', '4539 5076', 'FDBlanco@email.com', 'Cobrador', 'Mariano Fragueiro 4454', 'Juan B. Justo', 543, 2, 'C1', '101', 'Civil', 5, 'No', 'Activo', '2017-02-10', NULL, '2017-05-19', 'secretario', '2017-06-16', 'presidente'),
(7, '107', 'default.jpg', 'JOSE', 'RIBEIRO IGLESIAS', 473, '1958-09-12', 9307937, 'Viudo', 'Masculino', 'Cno C. de los Remedios 6800', 'Almirante Brown', 543, 5000, '621 576 563', '5188 7878', 'RIJose@email.com', 'Club', 'Cno C. de los Remedios 6800', 'Almirante Brown', 543, 6, 'M1', '101', 'Militar', 2, 'Si', 'Activo', '2017-03-10', NULL, '2017-05-19', 'secretario', '2017-06-16', 'presidente'),
(8, '108', 'default.jpg', 'ADRIAN', 'PICON IZAGUIRRE', 288, '1955-11-01', 50597168, 'Casado', 'Masculino', 'Pellegrini 50', 'Centro', 495, 5000, '734 549 092', '5408 0305', 'PIAdrian@email.com', 'Cobrador', 'Pellegrini 50', 'Centro', 495, 10, 'M1', '105', 'Militar', 3, 'Si', 'Activo', '2017-05-10', NULL, '2017-05-19', 'secretario', '2017-06-16', 'presidente'),
(9, '109', 'default.jpg', 'LAURA', 'VICENS ESPINOSA', 48, '1967-03-13', 81669527, 'Viudo', 'Femenino', 'Bv. Chacabuco 757 1A', 'Nueva Cordoba', 543, 5000, '712 171 042', '5421 3454', 'VELaura@email.com', 'Club', 'Bv. Chacabuco 757 1A', 'Centro', 543, 8, 'PV1', '101', 'Pensionista', 8, 'No', 'Activo', '2017-06-10', NULL, '2017-05-20', 'secretario', '2017-06-22', 'presidente');
...
(1, 4, 'Contador PÃƒÂºblico', 'Buenos Aires 971 Local 2', 'Nueva CÃƒÂ³rdoba', 543, 'Activo', '2017-05-19', 'secretario', '2017-06-14', 'secretario'),
...
(1, 1, 'No activo', 'Cabo Segundo', 'Armada', 'Ingeniero Mecanico', 'LUIS COMINO BELLES', 485, '1979-02-10', '2005-01-15', 'Activo', '2017-05-17', 'secretario', '2017-07-03', 'secretario'),
(2, 2, 'No activo', 'Cabo Primero', 'Armada', 'Electronicos', 'CESAR ILLESCAS LAGUNA', 485, '1975-09-14', '2006-02-11', 'Activo', '2017-05-17', 'secretario', '2017-05-19', 'secretario'),
(3, 3, 'No activo', 'Suboficial mayor', 'Armada', 'Armas', 'FRANCISCO JOSE MERCHAN', 90, '1980-01-20', '2011-02-09', 'Activo', '2017-05-17', 'secretario', '0000-00-00', ''),
(4, 5, 'No activo', 'Marinero de Primera', 'Armada', 'ElectrÃ³nicos', 'ALBERTO DE LA VEGA DUARTE', 449, '1979-05-20', '2010-12-11', 'Activo', '2017-05-19', 'secretario', '0000-00-00', ''),
(5, 7, 'No activo', 'Cabo segundo', 'Armada', 'ElectrÃ³nica', 'RUBEN SOARES MILAN', 473, '1981-05-14', '2012-11-02', 'Activo', '2017-05-19', 'secretario', '0000-00-00', ''),
(6, 8, 'No activo', 'Suboficial segundo', 'Armada', 'Operaciones', 'MOHAMED HERNAN TORREGROSA', 10, '1978-06-05', '2008-07-08', 'Activo', '2017-05-19', 'secretario', '0000-00-00', '');
...
(1, 9, 'Cabo Primero', 'Armada', 'Armas', 'LEANDRO VICENS ESPINOSA', 10, '1974-03-11', '2002-06-09', 'Activo', '2017-05-20', 'secretario', '0000-00-00', '');
...
(1, 1, 'Ingreso', NULL, 'Aprobado', '2017-05-17', 'secretario', '2016-12-10', 'presidente'),
(2, 2, 'Ingreso', NULL, 'Aprobado', '2017-05-17', 'secretario', '2016-12-10', 'presidente'),
(3, 3, 'Ingreso', NULL, 'Aprobado', '2017-05-17', 'secretario', '2017-01-10', 'presidente'),
(4, 4, 'Ingreso', NULL, 'Aprobado', '2017-05-19', 'secretario', '2017-01-10', 'presidente'),
(5, 5, 'Ingreso', NULL, 'Aprobado', '2017-05-19', 'secretario', '2017-01-10', 'presidente'),
(6, 6, 'Ingreso', NULL, 'Aprobado', '2017-05-19', 'secretario', '2017-02-10', 'presidente'),
(7, 7, 'Ingreso', NULL, 'Aprobado', '2017-05-19', 'secretario', '2017-03-10', 'presidente'),
(8, 8, 'Ingreso', NULL, 'Aprobado', '2017-05-19', 'secretario', '2017-05-10', 'presidente'),
(9, 9, 'Ingreso', NULL, 'Aprobado', '2017-05-20', 'secretario', '2017-06-10', 'presidente'),
(10, 2, 'Egreso', 'Baja: Mudanza', 'Aprobado', '2017-06-26', 'secretario', '2017-05-10', 'presidente'),
(11, 4, 'Egreso', 'Baja: Voluntaria', 'Aprobado', '2017-06-26', 'secretario', '2017-05-10', 'presidente');
...
(1, 1, 3, 'Aprobado', '2017-05-17', 'Aprueba', 'Activo', '2017-05-17', 'presidente', NULL, NULL, NULL, NULL),
(2, 2, 3, 'Aprobado', '2017-05-17', 'Aprobado', 'Activo', '2017-05-17', 'presidente', NULL, NULL, NULL, NULL),
(3, 4, 3, 'Aprobado', '2017-05-19', 'Sii', 'Activo', '2017-05-19', 'presidente', NULL, NULL, NULL, NULL),
(4, 3, 3, 'Aprobado', '2017-05-19', 'Aprobado', 'Activo', '2017-05-19', 'presidente', NULL, NULL, NULL, NULL),
(5, 9, 3, 'No aprobado', '2017-05-20', 'No Aprobado', 'Activo', '2017-05-20', 'presidente', NULL, NULL, NULL, NULL),
(6, 8, 3, 'No aprobado', '2017-05-20', 'No', 'Activo', '2017-05-20', 'presidente', NULL, NULL, NULL, NULL),
(8, 5, 3, 'Aprobado', '2017-06-16', 'Si', 'Activo', '2017-06-16', 'presidente', NULL, NULL, NULL, NULL),
(9, 6, 3, 'Aprobado', '2017-06-16', 'Si', 'Activo', '2017-06-16', 'presidente', NULL, NULL, NULL, NULL),
(10, 7, 3, 'Aprobado', '2017-06-16', 'Si', 'Activo', '2017-06-16', 'presidente', NULL, NULL, NULL, NULL),
(11, 10, 3, 'Aprobado', '2017-06-26', 'Aprobado', 'Activo', '2017-06-26', 'presidente', NULL, NULL, NULL, NULL),
(12, 11, 3, 'Aprobado', '2017-06-26', 'OK', 'Activo', '2017-06-26', 'presidente', NULL, NULL, NULL, NULL);
...
(1, 'administrador', 'e10adc3949ba59abbe56e057f20f883e', 'admin@admin.com', 'Activo', 'Administrador', '2017-02-19', 'administrador', '2017-06-14', 'administrador', NULL),
...
(6, 'auditor', 'e10adc3949ba59abbe56e057f20f883e', 'audi@audi.com', 'Activo', 'Auditor', '2017-02-19', 'administrador', '2017-06-14', 'administrador', NULL);
...
(2, 'Norte 2', NULL, 'Zona Intermedia Norte', 543, 'Activo', '2017-05-17', 'administrador', '0000-00-00', ''),
(3, 'Norte 3', NULL, 'Zona Periferica Norte', 543, 'Activo', '2017-05-17', 'administrador', '2017-06-14', 'administrador'),
