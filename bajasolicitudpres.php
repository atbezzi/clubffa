	...
	if ($accion == "alta")
			{
				...
				if($add){
					header("location:bajasolicitudpres.php?retorno=Activado correctamente");
				}else{
					header("location:bajasolicitudpres.php?retorno=" .mysql_error());
				}
			}
	if ($accion == "baja")
			{
				...
				if($add){
					header("location:bajasolicitudpres.php?retorno=Inactivado correctamente");
				}else{
					header("location:bajasolicitudpres.php?retorno=" .mysql_error());
				}
			}
...
<div id="container">
	...
	<div class="row" style="max-width:100%; margin-left:0px; margin-right:0px;">
		...
		<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
			<div class="main1">
				<div class="content">
					<h2><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Solicitud de Baja</h2>
					<br>
